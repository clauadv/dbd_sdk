...
{ 
	...
	SDK_UNDEFINED(16,5371) /* FString */               __um(Data);                                                 // 0x0010   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,5372) /* FString */               __um(BuildDate);                                            // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,5373) /* FString */               __um(DeviceName);                                           // 0x0018   (0x0010)  
	FGuid                                              InstanceId;                                                 // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,5374) /* FString */               __um(InstanceName);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,5375) /* FString */               __um(PlatformName);                                         // 0x0048   (0x0010)  
	FGuid                                              SESSIONID;                                                  // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,5376) /* FString */               __um(SessionName);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,5377) /* FString */               __um(SessionOwner);                                         // 0x0078   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,5378) /* FString */               __um(UserName);                                             // 0x0000   (0x0010)  
};
