...
public:
	...
	// void SetTormentMode(class ATormentMode* tormentModeComponent);                                                        // [0x5a8a730] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	class UClass*                                      _agonyBlindessStatusEffectClass;                            // 0x02C8   (0x0008)  
...
public:
	...
	class UClass*                                      _inTormentTrailKillerInstinctStatusEffectClass;             // 0x0190   (0x0008)  
	FDBDTunableRowHandle                               _attackTrailDamageCooldownTime;                             // 0x0198   (0x0028)  
	unsigned char                                      UnknownData03_5[0x18];                                      // 0x01C0   (0x0018)  MISSED
	TArray<FAgonyDisplayFxEvent>                       _showAgonyFXEvents;                                         // 0x01D8   (0x0010)  
	TArray<FAgonyDisplayFxEvent>                       _hideAgonyFXEvents;                                         // 0x01E8   (0x0010)  
	...
	// void ShowAgonyBarbWireFX_Cosmetic();                                                                                  // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.AgonyComponent.OnTrailEffectStop_Cosmetic
	// void OnTrailEffectStop_Cosmetic();                                                                                    // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.AgonyComponent.OnTrailEffectStart_Cosmetic
	// void OnTrailEffectStart_Cosmetic();                                                                                   // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.AgonyComponent.OnShowBarbWireFXOnGameEvent
	// void OnShowBarbWireFXOnGameEvent(FGameplayTag gameEventType, FGameEventData& GameEventData);                          // [0x5a8a150] Final|Native|Private|HasOutParms 
	// Function /Script/TheExecutioner.AgonyComponent.OnRep_IsInAgony
	// void OnRep_IsInAgony();                                                                                               // [0x5a8a110] Final|Native|Private 
	// Function /Script/TheExecutioner.AgonyComponent.OnLocallyObservedChanged
	// void OnLocallyObservedChanged(bool IsLocallyObserved);                                                                // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.AgonyComponent.OnHitInAgony_Cosmetic
	// void OnHitInAgony_Cosmetic();                                                                                         // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.AgonyComponent.OnHitByTormentAttackTrail_Cosmetic
	// void OnHitByTormentAttackTrail_Cosmetic();                                                                            // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.AgonyComponent.OnHideBarbWireFXOnGameEvent
	// void OnHideBarbWireFXOnGameEvent(FGameplayTag gameEventType, FGameEventData& GameEventData);                          // [0x5a8a000] Final|Native|Private|HasOutParms 
	// Function /Script/TheExecutioner.AgonyComponent.OnAgonyChanged_Cosmetic
	// void OnAgonyChanged_Cosmetic(bool IsInAgony);                                                                         // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.AgonyComponent.IsInAgony
	// bool IsInAgony();                                                                                                     // [0x5a89d40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TheExecutioner.AgonyComponent.IsAgonyMoriable
	// bool IsAgonyMoriable();                                                                                               // [0x5a89d10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TheExecutioner.AgonyComponent.HideAgonyBarbWireFX_Cosmetic
	// void HideAgonyBarbWireFX_Cosmetic();                                                                                  // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.AgonyComponent.Authority_OnDrainStageChanged
	// void Authority_OnDrainStageChanged(int32_t drainStage, class ADBDPlayer* Target);                                     // [0x5a899f0] Final|Native|Private 
	// Function /Script/TheExecutioner.AgonyComponent.Authority_OnAttackTrailDamageCooldownTimerDone
	// void Authority_OnAttackTrailDamageCooldownTimerDone();                                                                // [0x5a899d0] Final|Native|Private 
};
...
public:
	...
	// void EndOfDisapearCosmetic();                                                                                         // [0x5a89c10] Final|Native|Protected|BlueprintCallable 
	// Function /Script/TheExecutioner.BaseTormentTrailPoint.DisappearCosmetic
	// void DisappearCosmetic();                                                                                             // [0x61d2f50] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void Authority_OnInRangeChanged(bool inRange);                                                                        // [0x5a89ac0] Final|Native|Private 
};
...
public:
	...
	// void Multicast_TriggerDeathBedRelocate();                                                                             // [0x4dd4860] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/TheExecutioner.DeathBedAntiCampComponent.Authority_OnInRangeChanged
	// void Authority_OnInRangeChanged(bool inRange);                                                                        // [0x5a89b50] Final|Native|Private 
};
...
public:
	...
	// void TeleportCamperToDeathBed(bool shouldActivate);                                                                   // [0x5a8a7c0] Final|Native|Private|BlueprintCallable 
	// Function /Script/TheExecutioner.DeathBedInteractable.StartPlayerAbsorbedByGround
	// void StartPlayerAbsorbedByGround();                                                                                   // [0x61d2f50] Event|Public|BlueprintEvent 
	// Function /Script/TheExecutioner.DeathBedInteractable.SetInDeathBedCamper
	// void SetInDeathBedCamper(class ACamperPlayer* CamperPlayer);                                                          // [0x5a8a6a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/TheExecutioner.DeathBedInteractable.PlayerOverlapZoneEndOverlap
	// void PlayerOverlapZoneEndOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0x5a8a490] Final|Native|Private 
	// Function /Script/TheExecutioner.DeathBedInteractable.PlayerOverlapZoneBeginOverlap
	// void PlayerOverlapZoneBeginOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x5a8a280] Final|Native|Private|HasOutParms 
	// Function /Script/TheExecutioner.DeathBedInteractable.OnSkillCheckFailed_Cosmetic
	// void OnSkillCheckFailed_Cosmetic();                                                                                   // [0x61d2f50] BlueprintCosmetic|Event|Public|BlueprintEvent 
	// Function /Script/TheExecutioner.DeathBedInteractable.OnSkillCheckFailed
	// void OnSkillCheckFailed();                                                                                            // [0x5a8a260] Final|Native|Private 
	// Function /Script/TheExecutioner.DeathBedInteractable.OnRescueCancelled
	// void OnRescueCancelled();                                                                                             // [0x61d2f50] Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.DeathBedInteractable.OnRelocateStart_Cosmetic
	// void OnRelocateStart_Cosmetic();                                                                                      // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.DeathBedInteractable.OnDeathBedDeathEnd
	// void OnDeathBedDeathEnd();                                                                                            // [0x5a89fe0] Final|Native|Public|BlueprintCallable 
	// Function /Script/TheExecutioner.DeathBedInteractable.Multicast_RelocateToOtherDeathBed
	// void Multicast_RelocateToOtherDeathBed(class ADeathBedInteractable* deathBed, class ACamperPlayer* CamperPlayer);     // [0x5a89e40] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/TheExecutioner.DeathBedInteractable.GetRescuerSnapPosition
	// FVector GetRescuerSnapPosition();                                                                                     // [0x5a89c90] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TheExecutioner.DeathBedInteractable.GetMontagePlayer
	// class UMontagePlayer* GetMontagePlayer();                                                                             // [0x5a89c60] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TheExecutioner.DeathBedInteractable.GetInDeathBedCamper
	// class ACamperPlayer* GetInDeathBedCamper();                                                                           // [0x5a89c30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TheExecutioner.DeathBedInteractable.FX_SurvivorSavedFromDeathBed
	// void FX_SurvivorSavedFromDeathBed();                                                                                  // [0x61d2f50] BlueprintCosmetic|Event|Public|BlueprintEvent 
	// Function /Script/TheExecutioner.DeathBedInteractable.FX_DeathBedAppear
	// void FX_DeathBedAppear();                                                                                             // [0x61d2f50] BlueprintCosmetic|Event|Public|BlueprintEvent 
	// Function /Script/TheExecutioner.DeathBedInteractable.DeathBedDisappear
	// void DeathBedDisappear();                                                                                             // [0x61d2f50] Event|Public|BlueprintEvent 
	// Function /Script/TheExecutioner.DeathBedInteractable.CanRescueSurvivor
	// bool CanRescueSurvivor();                                                                                             // [0x5a89be0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TheExecutioner.DeathBedInteractable.ActivateDeathBed
	// void ActivateDeathBed(bool value);                                                                                    // [0x5a89940] Final|Native|Private|BlueprintCallable 
};
...
public:
	...
	// FVector GetRescuerSnapPosition();                                                                                     // [0x5a89cd0] Final|Native|Private|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRep_SurvivorsToReveal();                                                                                       // [0x5a8a130] Final|Native|Private 
	// Function /Script/TheExecutioner.Deathbound.MakeSurvivorScream
	// void MakeSurvivorScream(class ACamperPlayer* Survivor);                                                               // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.Deathbound.GetRevealLocationDuration
	// float GetRevealLocationDuration();                                                                                    // [0x4ffe5b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Server_TormentTryHitTargetNotInCoolDown(class ADBDPlayer* Target);                                               // [0x5a8a5e0] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/TheExecutioner.ExecutionerTormentAttack.Multicast_TormentHitTarget
	// void Multicast_TormentHitTarget(class ADBDPlayer* Target, bool hitCosmeticOnly);                                      // [0x5a89f10] Final|Net|NetReliableNative|Event|NetMulticast|Private 
};
...
public:
	...
	SDK_UNDEFINED(80,5459) /* TMap<ABaseTormentTrailPoint*, FTormentTrailPointInfo> */ __um(_instanceMap);         // 0x0258   (0x0050)  
	...
	// void Multicast_RemoveInstance(class ABaseTormentTrailPoint* TrailPoint);                                              // [0x5911580] Net|NetReliableNative|Event|NetMulticast|Public 
	// Function /Script/TheExecutioner.MobileTormentTrailRenderer.Multicast_AddInstance
	// void Multicast_AddInstance(class ABaseTormentTrailPoint* TrailPoint, bool isAttackTrailPoint);                        // [0x5a89d70] Net|NetReliableNative|Event|NetMulticast|Public 
};
...
public:
	...
	// void Server_OnActionInputPressed(class AGenerator* Generator);                                                        // [0x5a92250] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/TheExecutioner.RepressedAlliance.OnRep_CurrentRepairInteractionWithAbility
	// void OnRep_CurrentRepairInteractionWithAbility(class UInteractionDefinition* oldRepairInteraction);                   // [0x5a91f70] Final|Native|Private 
	// Function /Script/TheExecutioner.RepressedAlliance.OnRep_BlockedGenerator
	// void OnRep_BlockedGenerator(class AGenerator* oldGenerator);                                                          // [0x5a91ee0] Final|Native|Private 
	// Function /Script/TheExecutioner.RepressedAlliance.GetRepairTimesNeededToActivateAtLevel
	// float GetRepairTimesNeededToActivateAtLevel();                                                                        // [0x4fe80b0] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TheExecutioner.RepressedAlliance.GetGeneratorBlockDuration
	// float GetGeneratorBlockDuration();                                                                                    // [0x4fe81a0] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Multicast_SendCamperToDeathBed(class ADeathBedInteractable* deathBed);                                           // [0x5a91af0] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/TheExecutioner.SendToDeathBedInteraction.GetOwningSurvivor
	// class ACamperPlayer* GetOwningSurvivor();                                                                             // [0x5a91870] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TheExecutioner.SendToDeathBedInteraction.FX_InteractionStart
	// void FX_InteractionStart();                                                                                           // [0x61d2f50] BlueprintCosmetic|Event|Public|BlueprintEvent 
	// Function /Script/TheExecutioner.SendToDeathBedInteraction.FX_InteractionCancel
	// void FX_InteractionCancel();                                                                                          // [0x61d2f50] BlueprintCosmetic|Event|Public|BlueprintEvent 
};
...
public:
	...
	// void Authority_OnSurvivorHealed(FCamperHealResult& healResult);                                                       // [0x5a917a0] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void NoInputFeedbackCosmetic();                                                                                       // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void DBD_SetCanBeAgonyMoriedOnLocallyControlledPlayer(bool value, FString localPlayerId);                             // [0x580ccb0] Final|Exec|Native|Public 
	// Function /Script/TheExecutioner.TheExecutionerCheatComponent.DBD_SetAgonyOnLocallyControlledPlayer
	// void DBD_SetAgonyOnLocallyControlledPlayer(bool value, FString localPlayerId);                                        // [0x580ccb0] Final|Exec|Native|Public 
	// Function /Script/TheExecutioner.TheExecutionerCheatComponent.DBD_LocalKillSurvivorInDeathBed
	// void DBD_LocalKillSurvivorInDeathBed();                                                                               // [0x4592da0] Final|Exec|Native|Public 
	// Function /Script/TheExecutioner.TheExecutionerCheatComponent.DBD_DisplayAllDeathBed
	// void DBD_DisplayAllDeathBed(bool value);                                                                              // [0x581c030] Final|Exec|Native|Public 
	// Function /Script/TheExecutioner.TheExecutionerCheatComponent.DBD_DeathBedPlayStruggleHitReaction
	// void DBD_DeathBedPlayStruggleHitReaction();                                                                           // [0x4592da0] Final|Exec|Native|Public 
};
...
public:
	...
	// void RemoveTormentTrailController();                                                                                  // [0x5a92230] Final|Native|Protected|BlueprintCallable 
	// Function /Script/TheExecutioner.TrailControllerBase.OnTrailPointDeath
	// void OnTrailPointDeath(class ABaseTormentTrailPoint* baseTrailPoint);                                                 // [0x5a92110] Native|Protected     
	// Function /Script/TheExecutioner.TrailControllerBase.OnAcquireChanged
	// void OnAcquireChanged(bool acquired);                                                                                 // [0x5a91d40] Native|Protected     
	// Function /Script/TheExecutioner.TrailControllerBase.ActivateCosmetic
	// void ActivateCosmetic(bool value);                                                                                    // [0x61d2f50] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnTrailPointRemovedCosmetic(int32_t index);                                                                      // [0x5a921a0] Native|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.TormentAttackTrailController.OnStartTrailTimerDone
	// void OnStartTrailTimerDone();                                                                                         // [0x5a92000] Final|Native|Private 
	// Function /Script/TheExecutioner.TormentAttackTrailController.OnIntervalBetweenPointsTimerDone
	// void OnIntervalBetweenPointsTimerDone();                                                                              // [0x5a91ea0] Final|Native|Private 
	// Function /Script/TheExecutioner.TormentAttackTrailController.OnAttackTrailStartCosmetic
	// void OnAttackTrailStartCosmetic();                                                                                    // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.TormentAttackTrailController.Multicast_StartAttackTrail
	// void Multicast_StartAttackTrail(float serverTimeSpawn, FVector_NetQuantize10 Location, FRotator Rotation);            // [0x5a91b80] Final|Net|NetReliableNative|Event|NetMulticast|Private|HasDefaults 
	// Function /Script/TheExecutioner.TormentAttackTrailController.DisplayAttackTrailSpawnSign
	// void DisplayAttackTrailSpawnSign();                                                                                   // [0x5a91850] Native|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void DisplayTrailSplineMesh(class USplineComponent* splinemesh, int32_t indexInTrail);                                // [0x61d2f50] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void Server_RequestMoreActorInAttackPool();                                                                           // [0x5a92360] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/TheExecutioner.TormentMode.OnTormentModeStop_Cosmetic
	// void OnTormentModeStop_Cosmetic();                                                                                    // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.TormentMode.OnTormentModeStart_Cosmetic
	// void OnTormentModeStart_Cosmetic();                                                                                   // [0x61d2f50] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/TheExecutioner.TormentMode.OnTormentModeChargeEmpty
	// void OnTormentModeChargeEmpty();                                                                                      // [0x5a92020] Final|Native|Private 
	// Function /Script/TheExecutioner.TormentMode.IsInTormentMode
	// bool IsInTormentMode();                                                                                               // [0x5a91ac0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// FVector GetTormentTrailSpawnPoint();                                                                                  // [0x61d2f50] Event|Public|HasDefaults|BlueprintEvent 
	// Function /Script/TheExecutioner.Tormentor.GetTormentTrailAttackSpawnPoint
	// FVector GetTormentTrailAttackSpawnPoint();                                                                            // [0x61d2f50] Event|Public|HasDefaults|BlueprintEvent 
};
...
public:
	...
	// void Server_SpawnTormentTrailPoint(class ATormentTrailPoint* TrailPoint, FVector_NetQuantize10 Location, FRotator Rotation); // [0x5a92460] Final|Net|NetReliableNative|Event|Private|NetServer|HasDefaults|NetValidate 
};
...
public:
	...
	// void Server_RemoveTrailPoint();                                                                                       // [0x5a92310] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/TheExecutioner.TormentTrailPoint.RefreshTrailPointCosmetic
	// void RefreshTrailPointCosmetic(ETrailPointRefreshReason trailPointRefreshReason);                                     // [0x61d2f50] BlueprintCosmetic|Event|Public|BlueprintEvent 
	// Function /Script/TheExecutioner.TormentTrailPoint.OnAcquireChanged
	// void OnAcquireChanged(bool acquired);                                                                                 // [0x5a91cb0] Final|Native|Private 
	// Function /Script/TheExecutioner.TormentTrailPoint.Multicast_TriggerTrailPointDisappear
	// void Multicast_TriggerTrailPointDisappear();                                                                          // [0x435f040] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/TheExecutioner.TormentTrailPoint.GetTrailLocationAndTangeant
	// void GetTrailLocationAndTangeant(int32_t indexInTrail, class USplineComponent* SplineComponent, FVector& outStartLocation, FVector& outStartTangent, FVector& outEndLocation, FVector& outEndTangent); // [0x5a918a0] Final|Native|Private|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TheExecutioner.TormentTrailPoint.AddTrailCosmetic
	// void AddTrailCosmetic(class USplineComponent* SplineComponent, char indexInTrail);                                    // [0x61d2f50] Event|Public|BlueprintEvent 
...
public:
	...
	// void OnTrailAcquireChanged(class ATormentTrailPoint* TrailPoint, bool value);                                         // [0x5a92040] Final|Native|Private 
};
...
public:
	...
	// void Sever_SpawnTrailController(class ATormentTrailController* trailController, FVector_NetQuantize10 Location, FRotator Rotation); // [0x5a925e0] Final|Net|NetReliableNative|Event|Private|NetServer|HasDefaults|NetValidate 
	// Function /Script/TheExecutioner.TormentTrailSpawnerComponent.Server_StopTrailController
	// void Server_StopTrailController(class ATormentTrailController* trailController);                                      // [0x58cbe00] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/TheExecutioner.TormentTrailSpawnerComponent.Server_RequestMoreActorInPool
	// void Server_RequestMoreActorInPool(ETrailType trailType);                                                             // [0x5a923b0] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/TheExecutioner.TormentTrailSpawnerComponent.OnLevelReadyToPlay
	// void OnLevelReadyToPlay();                                                                                            // [0x5a91ec0] Final|Native|Private 
	// Function /Script/TheExecutioner.TormentTrailSpawnerComponent.OnInRangeChanged
	// void OnInRangeChanged(bool inRange, class AActor* Actor);                                                             // [0x5a91dd0] Final|Native|Private 
};
...
{ 
public:
	class UClass*                                      _modifySurvivorTrailEffectLastingTimeEffect;                // 0x02C8   (0x0008)  
	float                                              _trailEffectLastingTimeModifierValue;                       // 0x02D0   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x02D4   (0x0004)  MISSED
};
...
public:
	...
	// void OnRep_HighlightGenerator(class AGenerator* oldHighlightedGenerator);                                             // [0x5a92ca0] Final|Native|Private|Const 
	// Function /Script/TheExecutioner.TrailOfTorment.GetCooldownDurationAtLevel
	// float GetCooldownDurationAtLevel();                                                                                   // [0x4fe8260] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
