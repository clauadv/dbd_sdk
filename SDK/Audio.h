...
public:
	...
	// void Audio_K34_Distraction_Footstep_Only(class UAkAudioEvent* AkAudioEvent, class ABP_K34TipToeDistraction_C* K34Distraction, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Footstep_Only_Right_Back
	// void Audio_Killer_Footstep_Only_Right_Back(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Footstep_Only_Left_Back
	// void Audio_Killer_Footstep_Only_Left_Back(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Generator_Occlusion_Deactivate
	// void Audio_Generator_Occlusion_Deactivate(class UAkComponent* AkComponent, class AActor* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Generator_Occlusion_Activate
	// void Audio_Generator_Occlusion_Activate(class UAkComponent* AkComponent, class AActor* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Player_LocallyObserved
	// void Audio_Player_LocallyObserved(class AActor* Player, class UObject* __WorldContext, bool& IsLocallyObserved);      // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Hurt_Light_Hooked
	// void Audio_Survivor_Grunt_Hurt_Light_Hooked(class ADBDBasePlayer* Player, class UObject* __WorldContext);             // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Hurt_Light_Wiggle
	// void Audio_Survivor_Grunt_Hurt_Light_Wiggle(class ADBDBasePlayer* Player, class UObject* __WorldContext, bool& Return Value); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Cloth_ShuffleAttack
	// void Audio_Killer_Cloth_ShuffleAttack(class ADBDBasePlayer* Player, class UObject* __WorldContext);                   // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Weapon_Attack_Carry
	// void Audio_Killer_Weapon_Attack_Carry(class ADBDBasePlayer* Player, class UObject* __WorldContext);                   // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Haptic_LocallyObserved
	// void Audio_Haptic_LocallyObserved(class AActor* Actor, class UObject* __WorldContext);                                // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Cloth_Spawning
	// void Audio_Killer_Cloth_Spawning(class ADBDBasePlayer* Player, class UObject* __WorldContext);                        // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Weapon_Cooldown
	// void Audio_Killer_Weapon_Cooldown(class ADBDBasePlayer* Player, class UObject* __WorldContext);                       // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Scream_Short_K28
	// void Audio_Survivor_Grunt_Scream_Short_K28(class ADBDBasePlayer* Player, class UObject* __WorldContext);              // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Scream_Long_Mori_K28
	// void Audio_Survivor_Grunt_Scream_Long_Mori_K28(class ADBDBasePlayer* Player, class UObject* __WorldContext);          // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Dead
	// void Audio_Survivor_Dead(class ADBDBasePlayer* Player, class UObject* __WorldContext);                                // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Status_Start
	// void Audio_Survivor_Status_Start(class ADBDBasePlayer* Player, class UObject* __WorldContext);                        // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Stop
	// void Audio_Survivor_Grunt_Stop(class ADBDBasePlayer* Player, class UObject* __WorldContext);                          // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Scream_Long_Mori
	// void Audio_Survivor_Grunt_Scream_Long_Mori(class ADBDBasePlayer* Player, class UObject* __WorldContext);              // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Insanity_SnapOfIt
	// void Audio_Survivor_Grunt_Insanity_SnapOfIt(class ADBDBasePlayer* Player, class UObject* __WorldContext);             // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Insanity
	// void Audio_Survivor_Grunt_Insanity(class ADBDBasePlayer* Player, class UObject* __WorldContext);                      // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Scream_Hit_Mori
	// void Audio_Survivor_Grunt_Scream_Hit_Mori(class ADBDBasePlayer* Player, class UObject* __WorldContext);               // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Scream_Hit
	// void Audio_Survivor_Grunt_Scream_Hit(class ADBDBasePlayer* Player, class UObject* __WorldContext);                    // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Scream_Long
	// void Audio_Survivor_Grunt_Scream_Long(class ADBDBasePlayer* Player, class UObject* __WorldContext);                   // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Scream_Scare2d
	// void Audio_Survivor_Grunt_Scream_Scare2d(class ADBDBasePlayer* Player, class UObject* __WorldContext);                // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Scream_Scare
	// void Audio_Survivor_Grunt_Scream_Scare(class ADBDBasePlayer* Player, class UObject* __WorldContext);                  // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Hurt_Hard
	// void Audio_Survivor_Grunt_Hurt_Hard(class ADBDBasePlayer* Player, class UObject* __WorldContext);                     // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Cough
	// void Audio_Survivor_Grunt_Cough(class ADBDBasePlayer* Player, class UObject* __WorldContext);                         // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Hurt_Light
	// void Audio_Survivor_Grunt_Hurt_Light(class ADBDBasePlayer* Player, class UObject* __WorldContext, bool& Return Value); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Effort_Hard
	// void Audio_Survivor_Grunt_Effort_Hard(class ADBDBasePlayer* Player, class UObject* __WorldContext);                   // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt_Effort_Light
	// void Audio_Survivor_Grunt_Effort_Light(class ADBDBasePlayer* Player, class UObject* __WorldContext);                  // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Status
	// void Audio_Survivor_Status(FString AK Audio State, class ADBDBasePlayer* Player, class UObject* __WorldContext, FString& Audio State); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Post_AkEvent
	// void Audio_Survivor_Post_AkEvent(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Footstep_Right
	// void Audio_Survivor_Footstep_Right(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Footstep_Left
	// void Audio_Survivor_Footstep_Left(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Grunt
	// void Audio_Survivor_Grunt(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Survivor_Body
	// void Audio_Survivor_Body(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_K20_Weapon_Scrap
	// void Audio_K20_Weapon_Scrap(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Surface_Impact
	// void Audio_Killer_Surface_Impact(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Weapon_Impact_Survivor
	// void Audio_Killer_Weapon_Impact_Survivor(class ADBDBasePlayer* camper, class ADBDBasePlayer* Slasher, class UObject* __WorldContext); // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Weapon_Impact
	// void Audio_Killer_Weapon_Impact(class ADBDBasePlayer* Player, class UObject* __WorldContext);                         // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Weapon_PullOut
	// void Audio_Killer_Weapon_PullOut(class ADBDBasePlayer* Player, class UObject* __WorldContext);                        // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Weapon_Clean
	// void Audio_Killer_Weapon_Clean(class ADBDBasePlayer* Player, class UObject* __WorldContext);                          // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Weapon_Attack
	// void Audio_Killer_Weapon_Attack(class ADBDBasePlayer* Player, class UObject* __WorldContext);                         // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Weapon_Arm
	// void Audio_Killer_Weapon_Arm(class ADBDBasePlayer* Player, class UObject* __WorldContext);                            // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Setup
	// void Audio_Killer_Setup(class UAkComponent* AudioComponent, FName AudioStateKiller, class UAkAudioEvent* StartEvent, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Post_AkEvent
	// void Audio_Killer_Post_AkEvent(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Weapon
	// void Audio_Killer_Weapon(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Grunt
	// void Audio_Killer_Grunt(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Footstep_Only_Right_Front
	// void Audio_Killer_Footstep_Only_Right_Front(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Footstep_Only_Right
	// void Audio_Killer_Footstep_Only_Right(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Footstep_Only_Left_Front
	// void Audio_Killer_Footstep_Only_Left_Front(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Footstep_Only_Left
	// void Audio_Killer_Footstep_Only_Left(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Footstep_Right_Front
	// void Audio_Killer_Footstep_Right_Front(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Footstep_Right
	// void Audio_Killer_Footstep_Right(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Footstep_Left_Front
	// void Audio_Killer_Footstep_Left_Front(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Footstep_Left
	// void Audio_Killer_Footstep_Left(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Cloth_Land
	// void Audio_Killer_Cloth_Land(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Cloth_ShuffleLow
	// void Audio_Killer_Cloth_ShuffleLow(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Cloth_ShuffleHigh
	// void Audio_Killer_Cloth_ShuffleHigh(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/BP_Audio_FunctionLibrary.BP_Audio_FunctionLibrary_C.Audio_Killer_Cloth_Move
	// void Audio_Killer_Cloth_Move(class UAkAudioEvent* Ak Audio Event, class ADBDBasePlayer* Player, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
{ 
public:
	SDK_UNDEFINED(16,3545) /* FString */               __um(Attach_Name);                                          // 0x0040   (0x0010)  
	...
	SDK_UNDEFINED(16,3546) /* FString */               __um(AnimNotifyName);                                       // 0x0088   (0x0010)  
	...
	// void Should Execute Notify(class ADBDBasePlayer*& OwningPlayer, bool& ShouldExecute);                                 // [0x61c32d0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
...
public:
	...
	// void OnKillerSoundbankLoaded(EAkResult Result);                                                                       // [0x61c32d0] Protected|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/AudioBlueprints/Killer/BP_Audio_KLR_Base.BP_Audio_KLR_Base_C.OnKillerAudioDisabled
	// void OnKillerAudioDisabled();                                                                                         // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/AudioBlueprints/Killer/BP_Audio_KLR_Base.BP_Audio_KLR_Base_C.OnKillerAudioEnabled
	// void OnKillerAudioEnabled();                                                                                          // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/AudioBlueprints/Killer/BP_Audio_KLR_Base.BP_Audio_KLR_Base_C.SelectAudioStatusStartEvent
	// void SelectAudioStatusStartEvent(bool IsInMenu, class UAkAudioEvent*& AudioEvent);                                    // [0x61c32d0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Audio/AudioBlueprints/Killer/BP_Audio_KLR_Base.BP_Audio_KLR_Base_C.GetAudioCharacterName
	// void GetAudioCharacterName(class ADBDBasePlayer* Player, FName& AudioCharacterName);                                  // [0x61c32d0] Private|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Audio/AudioBlueprints/Killer/BP_Audio_KLR_Base.BP_Audio_KLR_Base_C.InititializeComponent
	// void InititializeComponent();                                                                                         // [0x61c32d0] Protected|BlueprintCallable|BlueprintEvent 
	...
	// void TriggerSurvivorDamageHitAudioSFX(class ACamperPlayer* camper, EAttackType attackType, bool CausedKO, bool IsWeaponHit, bool isLightHit); // [0x61c32d0] BlueprintCosmetic|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/AudioBlueprints/Killer/BP_Audio_KLR_Base.BP_Audio_KLR_Base_C.HitImpactOnSurvivorSFX
	// void HitImpactOnSurvivorSFX(class ACamperPlayer* camper, EAttackType attackType, bool IsWeaponHit);                   // [0x61c32d0] BlueprintCosmetic|Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/AudioBlueprints/Killer/BP_Audio_KLR_Base.BP_Audio_KLR_Base_C.ExecuteUbergraph_BP_Audio_KLR_Base
	// void ExecuteUbergraph_BP_Audio_KLR_Base(int32_t EntryPoint);                                                          // [0x61c32d0] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_BP_Audio_KLR_01(int32_t EntryPoint);                                                            // [0x61c32d0] Final                
};
...
public:
	...
	// bool HandleAnimNotify(class AActor* Player, FName& NotifyName);                                                       // [0x61c32d0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	// void ExecuteUbergraph_BP_Audio_KLR_03(int32_t EntryPoint);                                                            // [0x61c32d0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_BP_Audio_KLR_05(int32_t EntryPoint);                                                            // [0x61c32d0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_BP_Audio_KLR(int32_t EntryPoint);                                                               // [0x61c32d0] Final                
};
...
public:
	...
	// void OnKillerSoundbankLoaded(EAkResult Result);                                                                       // [0x61c32d0] Protected|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_Audio_KLR_09(int32_t EntryPoint);                                                            // [0x61c32d0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_BP_Audio_KLR_07(int32_t EntryPoint);                                                            // [0x61c32d0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_BP_Audio_KLR_08(int32_t EntryPoint);                                                            // [0x61c32d0] Final                
};
...
public:
	...
	SDK_UNDEFINED(16,3547) /* TArray<FString> */       __um(starsCharacter);                                       // 0x00D0   (0x0010)  
	...
	// void LobbyKillerReactionSpecificSurvivorSFX(TArray<ADBDMenuPlayer*>& menuPlayers);                                    // [0x61c32d0] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void ExecuteUbergraph_K24_KillerAudioMenuReaction(int32_t EntryPoint);                                                // [0x61c32d0] Final|HasDefaults    
};
...
public:
	FPointerToUberGraphFrame                           UberGraphFrame;                                             // 0x0208   (0x0008)  
	class UAkAudioEvent*                               AudioStatusStartMenuEvent;                                  // 0x0210   (0x0008)  
	SDK_UNDEFINED(16,3548) /* TArray<FString> */       __um(starsCharacter);                                       // 0x0218   (0x0010)  


	/// Functions
	// Function /Game/Audio/AudioBlueprints/Killer/BP_Audio_KLR.BP_Audio_KLR_24_C.IsCharacter
	// void IsCharacter(class ADBDPlayer* CamperPlayer, TArray<FString>& characterName, bool& IsCharacter);                  // [0x61c32d0] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void TriggerKillerReactionSpecificSurvivorSFX(class ADBDPlayer* camper);                                              // [0x61c32d0] BlueprintCosmetic|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Audio/AudioBlueprints/Killer/BP_Audio_KLR.BP_Audio_KLR_24_C.ChaseTriggerKillerReactionSpecificSurvivorSFX
	// void ChaseTriggerKillerReactionSpecificSurvivorSFX(class ADBDPlayer* camper);                                         // [0x61c32d0] BlueprintCosmetic|Event|Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_Audio_KLR(int32_t EntryPoint);                                                               // [0x61c32d0] Final|HasDefaults    
};
...
public:
	FPointerToUberGraphFrame                           UberGraphFrame;                                             // 0x0208   (0x0008)  
	class UAkAudioEvent*                               AudioStatusStartMenuEvent;                                  // 0x0210   (0x0008)  
	SDK_UNDEFINED(16,3549) /* TArray<FString> */       __um(starsCharacter);                                       // 0x0218   (0x0010)  
...
public:
	...
	// void ExecuteUbergraph_BP_Audio_KLR_04(int32_t EntryPoint);                                                            // [0x61c32d0] Final                
};
