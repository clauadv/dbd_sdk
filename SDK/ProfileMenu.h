...
public:
	...
	// void ExecuteUbergraph_WBP_ProfileMenuStatsWidget(int32_t EntryPoint);                                                 // [0x61d2f50] Final|HasDefaults    
};
...
public:
	...
	// void SetSubtitle(FText subtitleText);                                                                                 // [0x61d2f50] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/ProfileMenu/WBP_ProfileMenuTitle.WBP_ProfileMenuTitle_C.SetTitle
	// void SetTitle(FText titleText);                                                                                       // [0x61d2f50] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void ExecuteUbergraph_WBP_ProfileMenuSideNav(int32_t EntryPoint);                                                     // [0x61d2f50] Final                
};
...
public:
	...
	class UOverlay*                                    ContainerSize;                                              // 0x0410   (0x0008)  
	class UDBDImage*                                   DefaultTextBG;                                              // 0x0418   (0x0008)  
	class UOverlay*                                    NoCustomizationEquippedContainer;                           // 0x0420   (0x0008)  
	class UDBDTextBlock*                               NoCustomizationEquippedTB;                                  // 0x0428   (0x0008)  
	FSlateColor                                        TintColor;                                                  // 0x0430   (0x0028)  
	float                                              BadgeContainerSize;                                         // 0x0458   (0x0004)  
	float                                              BannerContainerSize;                                        // 0x045C   (0x0004)  


	/// Functions
	// Function /DBDUICore/ProfileMenu/WBP_ProfileMenuCustomizationWidget.WBP_ProfileMenuCustomizationWidget_C.SetScrollPrompt
	// void SetScrollPrompt(class UCoreKeyListenerInputPromptWidget* DisplayPrompt);                                         // [0x61d2f50] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetPreviewAreaData(FCustomizationItemPreviewAreaViewData& ViewData, bool noCustomizationEquipped);               // [0x61d2f50] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_ProfileMenuCustomizationWidget(int32_t EntryPoint);                                         // [0x61d2f50] Final|HasDefaults    
};
...
public:
	...
	class UDBDImage*                                   BackgroundFog;                                              // 0x0370   (0x0008)  
	class UDBDImage*                                   BackgroundFog0;                                             // 0x0378   (0x0008)  
	class UDBDImage*                                   BackgroundFog1;                                             // 0x0380   (0x0008)  
	class UDBDImage*                                   BackgroundFog2;                                             // 0x0388   (0x0008)  
	class UWBP_ProfileMenuCustomizationWidget_C*       BadgeMenuWidget;                                            // 0x0390   (0x0008)  
	class UWBP_ProfileMenuCustomizationWidget_C*       BannerMenuWidget;                                           // 0x0398   (0x0008)  
	class UDBDImage*                                   BG;                                                         // 0x03A0   (0x0008)  
	class UWidgetSwitcher*                             MenuTabsSwitcher;                                           // 0x03A8   (0x0008)  
	class UDBDImage*                                   NoMoveSmoke;                                                // 0x03B0   (0x0008)  
	class USpacer*                                     SPACER1;                                                    // 0x03B8   (0x0008)  
	class UWBP_ProfileMenuStatsWidget_C*               StatsMenuWidget;                                            // 0x03C0   (0x0008)  
	class UWBP_ProfileMenuTitle_C*                     TitleSection;                                               // 0x03C8   (0x0008)  


	/// Functions
	// Function /DBDUICore/ProfileMenu/WBP_ProfileMenuRoot.WBP_ProfileMenuRoot_C.SetScrollPrompts
	// void SetScrollPrompts();                                                                                              // [0x61d2f50] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/ProfileMenu/WBP_ProfileMenuRoot.WBP_ProfileMenuRoot_C.GetProfileMenuBadgeInterface
	// TScriptInterface<Class> GetProfileMenuBadgeInterface();                                                               // [0x61d2f50] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /DBDUICore/ProfileMenu/WBP_ProfileMenuRoot.WBP_ProfileMenuRoot_C.GetProfileMenuBannerInterface
	// TScriptInterface<Class> GetProfileMenuBannerInterface();                                                              // [0x61d2f50] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /DBDUICore/ProfileMenu/WBP_ProfileMenuRoot.WBP_ProfileMenuRoot_C.GetProfileMenuStatsInterface
	// TScriptInterface<Class> GetProfileMenuStatsInterface();                                                               // [0x61d2f50] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /DBDUICore/ProfileMenu/WBP_ProfileMenuRoot.WBP_ProfileMenuRoot_C.SetMenuState
	// void SetMenuState(EProfileMenuState menuState);                                                                       // [0x61d2f50] Event|Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetTitle(FText& Title);                                                                                          // [0x61d2f50] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void SettingsInputSwitcherEvent();                                                                                    // [0x61d2f50] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/ProfileMenu/WBP_ProfileMenuRoot.WBP_ProfileMenuRoot_C.ExecuteUbergraph_WBP_ProfileMenuRoot
	// void ExecuteUbergraph_WBP_ProfileMenuRoot(int32_t EntryPoint);                                                        // [0x61d2f50] Final|HasDefaults    
};
...
public:
	...
	class UGridPanel*                                  ContentGrid;                                                // 0x0498   (0x0008)  
	class UDBDImage*                                   Icon;                                                       // 0x04A0   (0x0008)  
	class UDBDImage*                                   IconBg;                                                     // 0x04A8   (0x0008)  
	class UWBP_CoreOnHoverBorder_C*                    OnHoverBorder;                                              // 0x04B0   (0x0008)  
	class UDBDImage*                                   Rollover;                                                   // 0x04B8   (0x0008)  
	class UDBDImage*                                   SelectedBG;                                                 // 0x04C0   (0x0008)  
	class UDBDImage*                                   Triangle;                                                   // 0x04C8   (0x0008)  
	class UTexture2D*                                  Texture;                                                    // 0x04D0   (0x0008)  
	...
	// void ExecuteUbergraph_WBP_ProfileMenuTab(int32_t EntryPoint);                                                         // [0x61d2f50] Final|HasDefaults    
};
