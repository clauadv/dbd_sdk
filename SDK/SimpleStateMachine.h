...
public:
	...
	SDK_UNDEFINED(80,5381) /* TSet<UClass*> */         __um(_stateClasses);                                        // 0x00D8   (0x0050)  
	SDK_UNDEFINED(80,5382) /* TSet<UClass*> */         __um(_transitionsClasses);                                  // 0x0128   (0x0050)  
	...
	SDK_UNDEFINED(80,5383) /* TMap<FName, USimpleStateMachineBaseState*> */ __um(_states);                         // 0x0320   (0x0050)  
