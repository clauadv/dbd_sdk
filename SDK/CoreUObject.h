...
public:
	...
	FName                                              NamePrivate;                                                // 0x0018   (0x000C)  
	class UObject*                                     OuterPrivate;                                               // 0x0024   (0x0008)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x002C   (0x0004)  MISSED


	/// Functions
	// Function /Script/CoreUObject.Object.ExecuteUbergraph
	// void ExecuteUbergraph(int32_t EntryPoint);                                                                            // [0x61c32d0] Event|Public|BlueprintEvent 
};
...
public:
	...
	unsigned char                                      UnknownData00_6[0x70];                                      // 0x0048   (0x0070)  MISSED
};
...
{ 
	...
	SDK_UNDEFINED(1,1) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                       // 0x0010   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x0011   (0x0003)  MISSED
};
...
{ 
	...
	SDK_UNDEFINED(1,2) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                       // 0x001C   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,3) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                       // 0x0028   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,4) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                       // 0x0040   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,5) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                       // 0x004C   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,6) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                       // 0x0034   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(16,7) /* FString */                  __um(SubPathString);                                        // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(1,9) /* TEnumAsByte<ERangeBoundTypes> */ __um(Type);                                             // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0001   (0x0003)  MISSED
...
{ 
	...
	SDK_UNDEFINED(16,11) /* FString */                 __um(NativeCulture);                                        // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,12) /* FString */                 __um(Namespace);                                            // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,13) /* FString */                 __um(Key);                                                  // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,14) /* FString */                 __um(NativeString);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(80,15) /* TMap<FString, FString> */  __um(LocalizedStrings);                                     // 0x0048   (0x0050)  
	bool                                               bIsMinimalPatch;                                            // 0x0098   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0099   (0x0007)  MISSED
	SDK_UNDEFINED(24,16) /* FText */                   __um(CachedText);                                           // 0x00A0   (0x0018)  
};
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
	SDK_UNDEFINED(16,17) /* FString */                 __um(Message);                                              // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,18) /* FString */                 __um(Context);                                              // 0x0018   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,19) /* FString */                 __um(Filename);                                             // 0x0038   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(80,20) /* TSet<FName> */             __um(RecursiveClassesExclusionSet);                         // 0x0090   (0x0050)  
...
{ 
	...
	unsigned char                                      UnknownData00_6[0x3C];                                      // 0x003C   (0x003C)  MISSED
};
