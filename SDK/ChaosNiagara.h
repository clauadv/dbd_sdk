...
public:
	...
	unsigned char                                      UnknownData04_5[0x3];                                       // 0x0101   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData05_5[0x1];                                       // 0x010F   (0x0001)  MISSED
	...
	unsigned char                                      UnknownData08_5[0x3];                                       // 0x01A1   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData09_5[0x3];                                       // 0x01D5   (0x0003)  MISSED
	int32_t                                            LastSpawnedPointID;                                         // 0x01D8   (0x0004)  
	float                                              LastSpawnTime;                                              // 0x01DC   (0x0004)  
	unsigned char                                      UnknownData10_5[0x10];                                      // 0x01E0   (0x0010)  MISSED
	float                                              SolverTime;                                                 // 0x01F0   (0x0004)  
	float                                              TimeStampOfLastProcessedData;                               // 0x01F4   (0x0004)  
	unsigned char                                      UnknownData11_6[0x48];                                      // 0x01F8   (0x0048)  MISSED
};
