...
public:
	...
	// void IncrementHookSpawned();                                                                                          // [0x4e64260] Final|Native|Static|Public|BlueprintCallable 
};

/// Class /Script/DBDAnalytics.AnalyticsManager
/// Size: 0x3678 (0x000038 - 0x0036B0)
class UAnalyticsManager : public UAbstractAnalyticsManager
{ 
public:
	unsigned char                                      UnknownData00_1[0x3678];                                    // 0x0038   (0x3678)  MISSED
};
...
public:
	...
	// void RecordClosetSearchSuccess(class ASlasherPlayer* killer);                                                         // [0x4e64300] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.ClosetAnalytics.RecordClosetSearchFail
	// void RecordClosetSearchFail(class ASlasherPlayer* killer);                                                            // [0x4e64280] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.ClosetAnalytics.IncrementClosetEnter
	// void IncrementClosetEnter(class ACamperPlayer* Survivor);                                                             // [0x4e641e0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SendTinkererUndetectableInterruptAnalytics(class ADBDPlayer* interruptedPlayer, class ADBDPlayer* Slasher);      // [0x4e72380] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PerkAnalyticsLibrary.SendTinkererUndetectableHitNearGeneratorAnalytics
	// void SendTinkererUndetectableHitNearGeneratorAnalytics(class ADBDPlayer* hitPlayer, class ADBDPlayer* Slasher);       // [0x4e722c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PerkAnalyticsLibrary.SendLightbornAuraRevealedAnalytics
	// void SendLightbornAuraRevealedAnalytics(class ADBDPlayer* revealedPlayer, class ADBDPlayer* Slasher);                 // [0x4e72200] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PerkAnalyticsLibrary.SendKnockoutSurvivorFoundAnalytics
	// void SendKnockoutSurvivorFoundAnalytics(class ADBDPlayer* findingSurvivor, class ADBDPlayer* foundSurvivor);          // [0x4e72140] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PerkAnalyticsLibrary.SendFranklinsHitSurvivorNearDroppedItemAnalytics
	// void SendFranklinsHitSurvivorNearDroppedItemAnalytics(class ADBDPlayer* hitSurvivor, class ADBDPlayer* Slasher);      // [0x4e72080] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PerkAnalyticsLibrary.SendFranklinsConsumeItemAnalytics
	// void SendFranklinsConsumeItemAnalytics(class ADBDPlayer* previousOwner);                                              // [0x4e72000] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void RecordRBTSearch(class ACamperPlayer* searchingPlayer, bool success);                                             // [0x4e71f40] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PigAnalytics.OnRBTAttached_Analytics
	// void OnRBTAttached_Analytics(class ASlasherPlayer* attacher, class ACamperPlayer* attachee);                          // [0x4e71e80] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PigAnalytics.IncrementRBTTimerActived
	// void IncrementRBTTimerActived(class ACamperPlayer* attachedPlayer);                                                   // [0x4e71e00] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PigAnalytics.IncrementRBTKilledCount
	// void IncrementRBTKilledCount(class ACamperPlayer* playerKilled, bool killedByExecutionZone);                          // [0x4e71d40] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void IncrementPalletStun(class ACamperPlayer* Survivor);                                                              // [0x4e71cc0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PulldownAnalytics.IncrementPalletSpawned
	// void IncrementPalletSpawned(class AActor* Actor);                                                                     // [0x4e71c40] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PulldownAnalytics.IncrementPalletDrop
	// void IncrementPalletDrop(class ACamperPlayer* Survivor);                                                              // [0x4e71bc0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PulldownAnalytics.IncrementPalletDestroy
	// void IncrementPalletDestroy(class ASlasherPlayer* killer);                                                            // [0x4e71b40] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void RecordHealSuccess(class ACamperPlayer* Survivor);                                                                // [0x4e75920] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.SurvivorInteractionAnalytics.RecordHatchEscape
	// void RecordHatchEscape(class ACamperPlayer* Survivor);                                                                // [0x4e758a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.SurvivorInteractionAnalytics.IncrementHealCount
	// void IncrementHealCount(class ACamperPlayer* Survivor);                                                               // [0x4e75820] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
	SDK_UNDEFINED(16,3733) /* FString */               __um(Version);                                              // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,3734) /* FString */               __um(Branch);                                               // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,3735) /* FString */               __um(Changelist);                                           // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,3736) /* FString */               __um(Configuration);                                        // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,3737) /* FString */               __um(MirrorsId);                                            // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,3738) /* FString */               __um(ClientId);                                             // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,3739) /* FString */               __um(platform);                                             // 0x0078   (0x0010)  
	SDK_UNDEFINED(16,3740) /* FString */               __um(BackendEnv);                                           // 0x0088   (0x0010)  
	SDK_UNDEFINED(16,3741) /* FString */               __um(DataContentVersion);                                   // 0x0098   (0x0010)  
	SDK_UNDEFINED(16,3742) /* FString */               __um(RunContext);                                           // 0x00A8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3743) /* FString */               __um(archiveId);                                            // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3744) /* FString */               __um(buttonId);                                             // 0x00C8   (0x0010)  
	int32_t                                            VideoProgress;                                              // 0x00D8   (0x0004)  
	bool                                               WasVideoWatchUntilEnd;                                      // 0x00DC   (0x0001)  
...
{ 
	SDK_UNDEFINED(16,3745) /* FString */               __um(archiveId);                                            // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3746) /* FString */               __um(VignetteId);                                           // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3747) /* FString */               __um(VideoId);                                              // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3748) /* FString */               __um(StartVideoTimestamp);                                  // 0x00E8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3749) /* FString */               __um(archiveId);                                            // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3750) /* FString */               __um(VignetteId);                                           // 0x00C8   (0x0010)  
	int32_t                                            EntryId;                                                    // 0x00D8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00DC   (0x0004)  MISSED
	SDK_UNDEFINED(16,3751) /* FString */               __um(SelectEntryTimestamp);                                 // 0x00E0   (0x0010)  
	...
	SDK_UNDEFINED(16,3752) /* FString */               __um(StartVoiceoverTimestamp);                              // 0x0100   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3753) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3754) /* FString */               __um(KrakenMatchId);                                        // 0x00C8   (0x0010)  
	EPlayerRole                                        Role;                                                       // 0x00D8   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x00D9   (0x0003)  MISSED
	float                                              MatchTime;                                                  // 0x00DC   (0x0004)  
	SDK_UNDEFINED(16,3755) /* FString */               __um(characterName);                                        // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,3756) /* FString */               __um(ReplacedCharacterMirrorsId);                           // 0x00F0   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3757) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	bool                                               IsABot;                                                     // 0x00C8   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x00C9   (0x0007)  MISSED
	SDK_UNDEFINED(16,3758) /* FString */               __um(MirrorsIdSurvivor);                                    // 0x00D0   (0x0010)  
	...
	SDK_UNDEFINED(16,3759) /* FString */               __um(StartingTileSurvivor);                                 // 0x0150   (0x0010)  
	SDK_UNDEFINED(16,3760) /* FString */               __um(EndingTileSurvivor);                                   // 0x0160   (0x0010)  
	int32_t                                            AmountOfTilesVisitedSurvivor;                               // 0x0170   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x0174   (0x0004)  MISSED
	SDK_UNDEFINED(16,3761) /* TArray<FString> */       __um(TilesVisitedSurvivor);                                 // 0x0178   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3762) /* FString */               __um(SenderMirrorsId);                                      // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3763) /* FString */               __um(SenderPlayerName);                                     // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3764) /* FString */               __um(MatchID);                                              // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3765) /* FString */               __um(ChatContent);                                          // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3766) /* FString */               __um(OriginalChatContent);                                  // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,3767) /* FString */               __um(ChatContext);                                          // 0x0108   (0x0010)  
	SDK_UNDEFINED(16,3768) /* FString */               __um(InGameTimestamp);                                      // 0x0118   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3769) /* FString */               __um(Location);                                             // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3770) /* FString */               __um(NetMode);                                              // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3771) /* FString */               __um(requester);                                            // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3772) /* FString */               __um(RequesterPlatform);                                    // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3773) /* FString */               __um(RequesterRole);                                        // 0x00F8   (0x0010)  
	int32_t                                            RequesterCharacterId;                                       // 0x0108   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x010C   (0x0004)  MISSED
	SDK_UNDEFINED(16,3774) /* FString */               __um(RequesterCharacterName);                               // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,3775) /* FString */               __um(MatchID);                                              // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,3776) /* FString */               __um(MatchType);                                            // 0x0130   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3777) /* FString */               __um(Type);                                                 // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,3778) /* FString */               __um(ExtraField1String);                                    // 0x0150   (0x0010)  
	int64_t                                            ExtraField1Integer;                                         // 0x0160   (0x0008)  
	double                                             ExtraField1Floating;                                        // 0x0168   (0x0008)  
	SDK_UNDEFINED(16,3779) /* FString */               __um(ExtraField2String);                                    // 0x0170   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3780) /* FString */               __um(Command);                                              // 0x0140   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3781) /* FString */               __um(Command);                                              // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,3782) /* FString */               __um(Type);                                                 // 0x0150   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3783) /* FString */               __um(Command);                                              // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,3784) /* FString */               __um(Type);                                                 // 0x0150   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3785) /* FString */               __um(ClientRole);                                           // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3786) /* FString */               __um(ClientSurvivorIndex);                                  // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3787) /* FString */               __um(ClientKillerIndex);                                    // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3788) /* FString */               __um(ClientPlatformAccountId);                              // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3789) /* FString */               __um(ClientMirrorsId);                                      // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,3790) /* FString */               __um(ClientPlatform);                                       // 0x0108   (0x0010)  
	SDK_UNDEFINED(16,3791) /* FString */               __um(ClientProvider);                                       // 0x0118   (0x0010)  
	SDK_UNDEFINED(16,3792) /* FString */               __um(ClientName);                                           // 0x0128   (0x0010)  
	SDK_UNDEFINED(16,3793) /* FString */               __um(MatchID);                                              // 0x0138   (0x0010)  
	SDK_UNDEFINED(16,3794) /* FString */               __um(gameType);                                             // 0x0148   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3795) /* FString */               __um(GameState);                                            // 0x0158   (0x0010)  
	SDK_UNDEFINED(16,3796) /* FString */               __um(GameFlowStep);                                         // 0x0168   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3797) /* FString */               __um(ClientOptions);                                        // 0x0158   (0x0010)  
	SDK_UNDEFINED(16,3798) /* FString */               __um(ClientMatchId);                                        // 0x0168   (0x0010)  
	SDK_UNDEFINED(16,3799) /* FString */               __um(ClientGameType);                                       // 0x0178   (0x0010)  
	SDK_UNDEFINED(16,3800) /* FString */               __um(LoginResult);                                          // 0x0188   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3801) /* FString */               __um(Action);                                               // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3802) /* FString */               __um(TargetKrakenUserId);                                   // 0x00C8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3803) /* FString */               __um(CurrencyName);                                         // 0x00B8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3804) /* FString */               __um(playerName);                                           // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3805) /* FString */               __um(Provider);                                             // 0x00C8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3806) /* FString */               __um(CustomizationSlot1);                                   // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3807) /* FString */               __um(CustomizationSlot2);                                   // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3808) /* FString */               __um(CustomizationSlot3);                                   // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3809) /* FString */               __um(Charm1);                                               // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3810) /* FString */               __um(Charm2);                                               // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,3811) /* FString */               __um(Charm3);                                               // 0x0108   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3812) /* FString */               __um(LobbyId);                                              // 0x0120   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3813) /* FString */               __um(MatchID);                                              // 0x0120   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3814) /* FString */               __um(Status);                                               // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3815) /* FString */               __um(ritualId);                                             // 0x00C8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3816) /* FString */               __um(Severity);                                             // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3817) /* FString */               __um(MatchID);                                              // 0x00C8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3818) /* FString */               __um(DSSessionProvider);                                    // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3819) /* FString */               __um(ServerStatus);                                         // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3820) /* FString */               __um(GameLiftSessionId);                                    // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3821) /* FString */               __um(MatchID);                                              // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3822) /* FString */               __um(SessionEndReason);                                     // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,3823) /* FString */               __um(FleetId);                                              // 0x0108   (0x0010)  
	SDK_UNDEFINED(16,3824) /* FString */               __um(IpAddress);                                            // 0x0118   (0x0010)  
	int32_t                                            Port;                                                       // 0x0128   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x012C   (0x0004)  MISSED
	SDK_UNDEFINED(16,3825) /* FString */               __um(DnsName);                                              // 0x0130   (0x0010)  
	SDK_UNDEFINED(16,3826) /* FString */               __um(Region);                                               // 0x0140   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3827) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3828) /* FString */               __um(InstigatorMirrorsId);                                  // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3829) /* FString */               __um(TargetMirrorsId);                                      // 0x00D8   (0x0010)  
	...
	SDK_UNDEFINED(16,3830) /* FString */               __um(InstigatorName);                                       // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,3831) /* FString */               __um(HitPrimitiveName);                                     // 0x0110   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,3832) /* FString */               __um(GameFlowStep);                                         // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,3833) /* FString */               __um(UnrealMapName);                                        // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,3834) /* FString */               __um(MapName);                                              // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,3835) /* FString */               __um(ThemeName);                                            // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,3836) /* FString */               __um(FailureType);                                          // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,3837) /* FString */               __um(ErrorString);                                          // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,3838) /* FString */               __um(MatchID);                                              // 0x0120   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3839) /* FString */               __um(PlayerPlatform);                                       // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3840) /* FString */               __um(MatchID);                                              // 0x00C8   (0x0010)  
	int32_t                                            InGameTime;                                                 // 0x00D8   (0x0004)  
	EPlayerRole                                        Role;                                                       // 0x00DC   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x00DD   (0x0003)  MISSED
	SDK_UNDEFINED(16,3841) /* FString */               __um(Reason);                                               // 0x00E0   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3842) /* FString */               __um(PlayerMirrorsId);                                      // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3843) /* FString */               __um(EquipedDisabledItemIds);                               // 0x00C8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3844) /* FString */               __um(LogMessage);                                           // 0x00B8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3845) /* FString */               __um(ViolationCase);                                        // 0x00C8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3846) /* FString */               __um(ProgressionType);                                      // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3847) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3848) /* FString */               __um(EmblemId);                                             // 0x00C8   (0x0010)  
	float                                              EmblemValue;                                                // 0x00D8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00DC   (0x0004)  MISSED
	SDK_UNDEFINED(16,3849) /* FString */               __um(EmblemQuality);                                        // 0x00E0   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3850) /* FString */               __um(ID);                                                   // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3851) /* FString */               __um(Environment);                                          // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3852) /* FString */               __um(Endpoint);                                             // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3853) /* FString */               __um(Language);                                             // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3854) /* FString */               __um(SelectedCountry);                                      // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3855) /* FString */               __um(Timezone);                                             // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,3856) /* FString */               __um(DeviceProfile);                                        // 0x0108   (0x0010)  
	SDK_UNDEFINED(16,3857) /* FString */               __um(GpuAdapter);                                           // 0x0118   (0x0010)  
	SDK_UNDEFINED(16,3858) /* FString */               __um(GpuProviderName);                                      // 0x0128   (0x0010)  
	SDK_UNDEFINED(16,3859) /* FString */               __um(GpuDriverVersion);                                     // 0x0138   (0x0010)  
	SDK_UNDEFINED(16,3860) /* FString */               __um(RHIName);                                              // 0x0148   (0x0010)  
	SDK_UNDEFINED(16,3861) /* FString */               __um(Cpu);                                                  // 0x0158   (0x0010)  
	...
	SDK_UNDEFINED(16,3862) /* FString */               __um(Provider);                                             // 0x0188   (0x0010)  
	SDK_UNDEFINED(16,3863) /* FString */               __um(Device);                                               // 0x0198   (0x0010)  
	SDK_UNDEFINED(16,3864) /* FString */               __um(OperatingSystem);                                      // 0x01A8   (0x0010)  
	bool                                               IsPlayingUsingStreaming;                                    // 0x01B8   (0x0001)  
	unsigned char                                      UnknownData03_5[0x7];                                       // 0x01B9   (0x0007)  MISSED
	SDK_UNDEFINED(16,3865) /* FString */               __um(StreamingService);                                     // 0x01C0   (0x0010)  
	SDK_UNDEFINED(16,3866) /* FString */               __um(StreamingServerLocation);                              // 0x01D0   (0x0010)  
	SDK_UNDEFINED(16,3867) /* FString */               __um(KrakenVersion);                                        // 0x01E0   (0x0010)  
	SDK_UNDEFINED(16,3868) /* FString */               __um(ContentVersion);                                       // 0x01F0   (0x0010)  
	bool                                               IsUsingKeyboard;                                            // 0x0200   (0x0001)  
	unsigned char                                      UnknownData04_5[0x7];                                       // 0x0201   (0x0007)  MISSED
	SDK_UNDEFINED(16,3869) /* FString */               __um(ControllerType);                                       // 0x0208   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3870) /* FString */               __um(ErrorCategory);                                        // 0x00B8   (0x0010)  
	...
	SDK_UNDEFINED(16,3871) /* FString */               __um(StringField1);                                         // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3872) /* FString */               __um(StringField2);                                         // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3873) /* FString */               __um(StringField3);                                         // 0x00F8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3874) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3875) /* FString */               __um(FallOutMirrorsId);                                     // 0x00C8   (0x0010)  
	float                                              X;                                                          // 0x00D8   (0x0004)  
	float                                              Y;                                                          // 0x00DC   (0x0004)  
	float                                              Z;                                                          // 0x00E0   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00E4   (0x0004)  MISSED
	SDK_UNDEFINED(16,3876) /* FString */               __um(TileName);                                             // 0x00E8   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,3877) /* FString */               __um(CurrentMap);                                           // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3878) /* FString */               __um(CurrentGameMap);                                       // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3879) /* FString */               __um(GameFlowStep);                                         // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3880) /* FString */               __um(CurrentGameFlowContext);                               // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,3881) /* FString */               __um(PreviousGameFlowContext);                              // 0x0108   (0x0010)  
	SDK_UNDEFINED(16,3882) /* FString */               __um(NavigationContext);                                    // 0x0118   (0x0010)  
	SDK_UNDEFINED(16,3883) /* FString */               __um(PreviousNavigationContext);                            // 0x0128   (0x0010)  
	SDK_UNDEFINED(16,3884) /* FString */               __um(RecentLogs);                                           // 0x0138   (0x0010)  
	SDK_UNDEFINED(16,3885) /* FString */               __um(KrakenMatchId);                                        // 0x0148   (0x0010)  
	...
	SDK_UNDEFINED(16,3886) /* FString */               __um(gameType);                                             // 0x0168   (0x0010)  
	SDK_UNDEFINED(16,3887) /* FString */               __um(NetMode);                                              // 0x0178   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3888) /* FString */               __um(Verbosity);                                            // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3889) /* FString */               __um(category);                                             // 0x00C8   (0x0010)  
	uint64_t                                           FrameCounter;                                               // 0x00D8   (0x0008)  
	SDK_UNDEFINED(16,3890) /* FString */               __um(Message);                                              // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,3891) /* FString */               __um(StackTrace);                                           // 0x00F0   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3892) /* FString */               __um(InitGuid);                                             // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3893) /* FString */               __um(ProgressionName);                                      // 0x00C8   (0x0010)  
	bool                                               success;                                                    // 0x00D8   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x00D9   (0x0007)  MISSED
	SDK_UNDEFINED(16,3894) /* FString */               __um(LoadCompleteState);                                    // 0x00E0   (0x0010)  
	float                                              ElapsedTime;                                                // 0x00F0   (0x0004)  
	uint32_t                                           FailureCount;                                               // 0x00F4   (0x0004)  
	SDK_UNDEFINED(16,3895) /* FString */               __um(AdditionalInfo);                                       // 0x00F8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3896) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3897) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3898) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3899) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	float                                              Speed;                                                      // 0x00C8   (0x0004)  
...
{ 
	SDK_UNDEFINED(16,3900) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3901) /* FString */               __um(MapName);                                              // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3902) /* FString */               __um(Marker);                                               // 0x00D8   (0x0010)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x00B9   (0x0007)  MISSED
	SDK_UNDEFINED(16,3903) /* FString */               __um(HangSourcesInfo);                                      // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,3904) /* FString */               __um(HangLogs);                                             // 0x00D0   (0x0010)  
	float                                              LastLoadingProgression;                                     // 0x00E0   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00E4   (0x0004)  MISSED
	SDK_UNDEFINED(16,3905) /* FString */               __um(AdditionalLogs);                                       // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3906) /* FString */               __um(MatchID);                                              // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,3907) /* FString */               __um(HangSourcesName);                                      // 0x0108   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3908) /* FString */               __um(BeatTime);                                             // 0x00B8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3909) /* FString */               __um(ItemId);                                               // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3910) /* FString */               __um(Provider);                                             // 0x00C8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3911) /* FString */               __um(PlayerMirrorsId);                                      // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3912) /* FString */               __um(ItemType);                                             // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3913) /* FString */               __um(Items);                                                // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3914) /* FString */               __um(Reason);                                               // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3915) /* FString */               __um(PlayerRole);                                           // 0x00F8   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,3916) /* FString */               __um(CallingFunctionName);                                  // 0x00C8   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,3917) /* FString */               __um(tutorialId);                                           // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3918) /* FString */               __um(OnboardingModeId);                                     // 0x00E8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3919) /* FString */               __um(KrakenUrl);                                            // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3920) /* FString */               __um(Method);                                               // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3921) /* FString */               __um(Route);                                                // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3922) /* FString */               __um(Status);                                               // 0x00E8   (0x0010)  
	...
	SDK_UNDEFINED(16,3923) /* FString */               __um(Country);                                              // 0x0108   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3924) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3925) /* FString */               __um(MapName);                                              // 0x00C8   (0x0010)  
	int32_t                                            Seed;                                                       // 0x00D8   (0x0004)  
	float                                              TimeElapsed;                                                // 0x00DC   (0x0004)  
	float                                              TimeElapsedInStep;                                          // 0x00E0   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00E4   (0x0004)  MISSED
	SDK_UNDEFINED(16,3926) /* FString */               __um(LoadingStep);                                          // 0x00E8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3927) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3928) /* FString */               __um(MapName);                                              // 0x00C8   (0x0010)  
	int32_t                                            Seed;                                                       // 0x00D8   (0x0004)  
	float                                              TimeElapsed;                                                // 0x00DC   (0x0004)  
	float                                              TimeElapsedInStep;                                          // 0x00E0   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00E4   (0x0004)  MISSED
	SDK_UNDEFINED(16,3929) /* FString */               __um(LoadingStep);                                          // 0x00E8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3930) /* FString */               __um(match_id);                                             // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3931) /* FString */               __um(lobby_id);                                             // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3932) /* FString */               __um(timeout_timestamp);                                    // 0x00D8   (0x0010)  
	float                                              total_load_time;                                            // 0x00E8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00EC   (0x0004)  MISSED
	SDK_UNDEFINED(16,3933) /* FString */               __um(current_map_name);                                     // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,3934) /* FString */               __um(transition_id);                                        // 0x0100   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3935) /* FString */               __um(match_id);                                             // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3936) /* FString */               __um(lobby_id);                                             // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3937) /* FString */               __um(step_change_timestamp);                                // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3938) /* FString */               __um(loading_step);                                         // 0x00E8   (0x0010)  
	float                                              time_on_prev_step;                                          // 0x00F8   (0x0004)  
	float                                              total_load_time;                                            // 0x00FC   (0x0004)  
	SDK_UNDEFINED(16,3939) /* FString */               __um(current_map_name);                                     // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,3940) /* FString */               __um(transition_id);                                        // 0x0110   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3941) /* FString */               __um(LoadoutItem);                                          // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3942) /* FString */               __um(LoadoutItemAddOn1);                                    // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3943) /* FString */               __um(LoadoutItemAddOn2);                                    // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3944) /* FString */               __um(LoadoutPerk1);                                         // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3945) /* FString */               __um(LoadoutPerk2);                                         // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,3946) /* FString */               __um(LoadoutPerk3);                                         // 0x0108   (0x0010)  
	SDK_UNDEFINED(16,3947) /* FString */               __um(LoadoutPerk4);                                         // 0x0118   (0x0010)  
	SDK_UNDEFINED(16,3948) /* FString */               __um(LoadoutOffering);                                      // 0x0128   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,3949) /* FString */               __um(characterName);                                        // 0x0148   (0x0010)  
	SDK_UNDEFINED(16,3950) /* FString */               __um(LobbyId);                                              // 0x0158   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3951) /* FString */               __um(MatchID);                                              // 0x0140   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3952) /* FString */               __um(LogMirrors);                                           // 0x00B8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3953) /* FString */               __um(Context);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3954) /* FString */               __um(Message);                                              // 0x00C8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3955) /* FString */               __um(Type);                                                 // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,3956) /* FString */               __um(Actor);                                                // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3957) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3958) /* FString */               __um(MapId);                                                // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,3959) /* FString */               __um(ThemeId);                                              // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3960) /* FString */               __um(KrakenMatchId);                                        // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3961) /* FString */               __um(SelectedMapId);                                        // 0x00C8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3962) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,3963) /* FString */               __um(playerID);                                             // 0x00C8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3964) /* FString */               __um(GameMode);                                             // 0x00B8   (0x0010)  
	int32_t                                            KillerPercentageIncentive;                                  // 0x00C8   (0x0004)  
	int32_t                                            SurvivorPercentageIncentive;                                // 0x00CC   (0x0004)  
};
...
{ 
	...
	SDK_UNDEFINED(16,3965) /* FString */               __um(BotId);                                                // 0x00C0   (0x0010)  
	...
	SDK_UNDEFINED(16,3966) /* FString */               __um(characterName);                                        // 0x00D8   (0x0010)  
	...
	SDK_UNDEFINED(16,3967) /* FString */               __um(MapName);                                              // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,3968) /* FString */               __um(PartyHostMirrorsId);                                   // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,3969) /* FString */               __um(LobbyId);                                              // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,3970) /* FString */               __um(MatchID);                                              // 0x0130   (0x0010)  
	SDK_UNDEFINED(16,3971) /* FString */               __um(KrakenMatchId);                                        // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,3972) /* FString */               __um(playerName);                                           // 0x0150   (0x0010)  
	SDK_UNDEFINED(16,3973) /* FString */               __um(SelectedCountry);                                      // 0x0160   (0x0010)  
	...
	SDK_UNDEFINED(16,3974) /* FString */               __um(LastMatchTimestamp);                                   // 0x0180   (0x0010)  
	...
	SDK_UNDEFINED(16,3975) /* FString */               __um(ControllerType);                                       // 0x0198   (0x0010)  
	SDK_UNDEFINED(16,3976) /* FString */               __um(ColorBlindMode);                                       // 0x01A8   (0x0010)  
	...
	SDK_UNDEFINED(16,3977) /* FString */               __um(OnboardingModeId);                                     // 0x01C0   (0x0010)  
	...
	SDK_UNDEFINED(16,3978) /* FString */               __um(ServerSessionId);                                      // 0x01E0   (0x0010)  
	SDK_UNDEFINED(16,3979) /* FString */               __um(ServerRegion);                                         // 0x01F0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3980) /* FString */               __um(MatchmakingSessionGuid);                               // 0x00B8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3981) /* FString */               __um(MatchmakingSessionGuid);                               // 0x00B8   (0x0010)  
	...
	SDK_UNDEFINED(16,3982) /* FString */               __um(characterName);                                        // 0x00D8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3983) /* FString */               __um(LobbyStartTime);                                       // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3984) /* FString */               __um(LobbyEndTime);                                         // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,3985) /* FString */               __um(LobbyResult);                                          // 0x0108   (0x0010)  
	SDK_UNDEFINED(16,3986) /* FString */               __um(KrakenMatchId);                                        // 0x0118   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,3987) /* FString */               __um(QueueStartTime);                                       // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,3988) /* FString */               __um(QueueEndTime);                                         // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,3989) /* FString */               __um(QueueResult);                                          // 0x0108   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,3990) /* FString */               __um(ConnectingToUser);                                     // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,3991) /* FString */               __um(SearchParams);                                         // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,3992) /* FString */               __um(SearchResultSettings);                                 // 0x00E8   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,3993) /* FString */               __um(HostSettings);                                         // 0x00C8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3994) /* FString */               __um(SessionName);                                          // 0x00B8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,3995) /* FString */               __um(Log);                                                  // 0x00B8   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,3996) /* FString */               __um(Error);                                                // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,3997) /* FString */               __um(JoiningUserID);                                        // 0x00D0   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,3998) /* FString */               __um(MatchWaitStartUtc);                                    // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,3999) /* FString */               __um(MatchWaitStopUtc);                                     // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,4000) /* FString */               __um(LobbyWaitStartUtc);                                    // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,4001) /* FString */               __um(LobbyWaitStopUtc);                                     // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,4002) /* FString */               __um(LobbyWaitStopReason);                                  // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,4003) /* FString */               __um(MatchID);                                              // 0x0110   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,4004) /* FString */               __um(SelectedCountry);                                      // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4005) /* FString */               __um(playerName);                                           // 0x00D8   (0x0010)  
	...
	SDK_UNDEFINED(16,4006) /* FString */               __um(LastMatchTimestamp);                                   // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,4007) /* FString */               __um(SessionStartTimestamp);                                // 0x0108   (0x0010)  
	SDK_UNDEFINED(16,4008) /* FString */               __um(SessionEndTimestamp);                                  // 0x0118   (0x0010)  
	SDK_UNDEFINED(16,4009) /* FString */               __um(LastSessionTimestamp);                                 // 0x0128   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,4010) /* FString */               __um(MatchID);                                              // 0x00C0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4011) /* FString */               __um(GameFlowStep);                                         // 0x00B8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4012) /* FString */               __um(CurrentTab);                                           // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,4013) /* FString */               __um(PreviousTab);                                          // 0x0010   (0x0010)  
	float                                              TimeOnPreviousTab;                                          // 0x0020   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0024   (0x0004)  MISSED
	SDK_UNDEFINED(16,4014) /* FString */               __um(TabChangeTimestamp);                                   // 0x0028   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4015) /* FString */               __um(Button);                                               // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,4016) /* FString */               __um(ButtonPressTimestamp);                                 // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4017) /* FString */               __um(CurrentContext);                                       // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4018) /* FString */               __um(PreviousContext);                                      // 0x00C8   (0x0010)  
	float                                              TimeOnPreviousContext;                                      // 0x00D8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00DC   (0x0004)  MISSED
	SDK_UNDEFINED(16,4019) /* FString */               __um(ContextChangeTimetamp);                                // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,4020) /* FString */               __um(MatchID);                                              // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,4021) /* FString */               __um(LobbyId);                                              // 0x0100   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4022) /* FString */               __um(EventTimestamp);                                       // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4023) /* FString */               __um(EventName);                                            // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4024) /* FString */               __um(Data);                                                 // 0x00D8   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,4025) /* FString */               __um(EventTimestamp);                                       // 0x00C0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4026) /* FString */               __um(Reason);                                               // 0x00B8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4027) /* FString */               __um(ErrorType);                                            // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4028) /* FString */               __um(Filename);                                             // 0x00C8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4029) /* FString */               __um(PartyId);                                              // 0x00B8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4030) /* FString */               __um(Error);                                                // 0x00C8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4031) /* FString */               __um(Error);                                                // 0x00C8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4032) /* FString */               __um(InviteeId);                                            // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4033) /* FString */               __um(InviteeName);                                          // 0x00D8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4034) /* FString */               __um(InviteeId);                                            // 0x00C8   (0x0010)  
	bool                                               success;                                                    // 0x00D8   (0x0001)  
...
{ 
	SDK_UNDEFINED(16,4035) /* FString */               __um(PartyMembersFriendshipStatus);                         // 0x00B8   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,4036) /* FString */               __um(DeviceProfile);                                        // 0x01D8   (0x0010)  
	...
	SDK_UNDEFINED(16,4037) /* FString */               __um(Scenario);                                             // 0x0280   (0x0010)  
	SDK_UNDEFINED(16,4038) /* FString */               __um(Theme);                                                // 0x0290   (0x0010)  
	SDK_UNDEFINED(16,4039) /* FString */               __um(MapName);                                              // 0x02A0   (0x0010)  
	int32_t                                            TileListCount;                                              // 0x02B0   (0x0004)  
	int32_t                                            Seed;                                                       // 0x02B4   (0x0004)  
	SDK_UNDEFINED(16,4040) /* FString */               __um(characterName);                                        // 0x02B8   (0x0010)  
	SDK_UNDEFINED(16,4041) /* FString */               __um(Cpu);                                                  // 0x02C8   (0x0010)  
	SDK_UNDEFINED(16,4042) /* FString */               __um(GpuAdapter);                                           // 0x02D8   (0x0010)  
	SDK_UNDEFINED(16,4043) /* FString */               __um(MatchID);                                              // 0x02E8   (0x0010)  
	SDK_UNDEFINED(16,4044) /* FString */               __um(RHIName);                                              // 0x02F8   (0x0010)  
	bool                                               IsSample;                                                   // 0x0308   (0x0001)  
	unsigned char                                      UnknownData02_5[0x7];                                       // 0x0309   (0x0007)  MISSED
	SDK_UNDEFINED(16,4045) /* FString */               __um(GameFlowStep);                                         // 0x0310   (0x0010)  
	SDK_UNDEFINED(16,4046) /* FString */               __um(KrakenMatchId);                                        // 0x0320   (0x0010)  
	SDK_UNDEFINED(16,4047) /* TArray<FString> */       __um(Characters);                                           // 0x0330   (0x0010)  
	SDK_UNDEFINED(16,4048) /* TArray<FString> */       __um(Perks);                                                // 0x0340   (0x0010)  
	SDK_UNDEFINED(16,4049) /* TArray<FString> */       __um(CustomizationItems);                                   // 0x0350   (0x0010)  
	SDK_UNDEFINED(16,4050) /* FString */               __um(gameType);                                             // 0x0360   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4051) /* FString */               __um(Scenario);                                             // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4052) /* FString */               __um(Theme);                                                // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4053) /* FString */               __um(map_name);                                             // 0x00D8   (0x0010)  
	int32_t                                            tile_spawn_count;                                           // 0x00E8   (0x0004)  
	int32_t                                            Seed;                                                       // 0x00EC   (0x0004)  
	SDK_UNDEFINED(16,4054) /* FString */               __um(match_id);                                             // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,4055) /* FString */               __um(character_name);                                       // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,4056) /* FString */               __um(cpu_name);                                             // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,4057) /* FString */               __um(gpu_name);                                             // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,4058) /* FString */               __um(Resolution);                                           // 0x0130   (0x0010)  
	int32_t                                            graphics_quality_level;                                     // 0x0140   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0144   (0x0004)  MISSED
	SDK_UNDEFINED(16,4059) /* FString */               __um(hitch_times);                                          // 0x0148   (0x0010)  
	...
	SDK_UNDEFINED(16,4060) /* FString */               __um(texturegroups_guid);                                   // 0x01E8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4061) /* FString */               __um(characterName);                                        // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4062) /* FString */               __um(perkId);                                               // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4063) /* FString */               __um(PerkSource);                                           // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,4064) /* FString */               __um(Duplicate);                                            // 0x00E8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4065) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4066) /* FString */               __um(HitSurvivorMirrorsId);                                 // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,4067) /* FString */               __um(AttackingSlasherMirrorsId);                            // 0x00E0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4068) /* FString */               __um(PreviousOwnerSurvivorMirrorsId);                       // 0x00D0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4069) /* FString */               __um(RescuingSurvivorMirrorsId);                            // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,4070) /* FString */               __um(FoundSurvivorMirrorsId);                               // 0x00E0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4071) /* FString */               __um(InterruptedSurvivorMirrorsId);                         // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,4072) /* FString */               __um(InterruptingSlasherMirrorsId);                         // 0x00E0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4073) /* FString */               __um(HitSurvivorMirrorsId);                                 // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,4074) /* FString */               __um(AttackingSlasherMirrorsId);                            // 0x00E0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4075) /* FString */               __um(RevealedSurvivorMirrorsId);                            // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,4076) /* FString */               __um(FlashlightedSlasherMirrorsId);                         // 0x00E0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4077) /* FString */               __um(AnimationSetting);                                     // 0x00B8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4078) /* FString */               __um(Provider);                                             // 0x00B8   (0x0010)  
	int32_t                                            tabIndex;                                                   // 0x00C8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00CC   (0x0004)  MISSED
	SDK_UNDEFINED(16,4079) /* FString */               __um(FromScreen);                                           // 0x00D0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4080) /* FString */               __um(Badge);                                                // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4081) /* FString */               __um(Banner);                                               // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4082) /* FString */               __um(FromScreen);                                           // 0x00D8   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,4087) /* FString */               __um(MatchID);                                              // 0x0148   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4088) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	int32_t                                            ElapsedMatchTime;                                           // 0x00C8   (0x0004)  
	int32_t                                            NbOfConcurrentStatusEffects;                                // 0x00CC   (0x0004)  
	SDK_UNDEFINED(16,4089) /* TArray<FString> */       __um(StatusEffects);                                        // 0x00D0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4090) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4091) /* FString */               __um(KrakenMatchId);                                        // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4092) /* FString */               __um(GameMode);                                             // 0x00D8   (0x0010)  
	int32_t                                            BloodwebPoints;                                             // 0x00E8   (0x0004)  
	int32_t                                            BonusEvent;                                                 // 0x00EC   (0x0004)  
	int32_t                                            MatchIncentive;                                             // 0x00F0   (0x0004)  
	int32_t                                            LteIncentive;                                               // 0x00F4   (0x0004)  
	float                                              GameDuration;                                               // 0x00F8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00FC   (0x0004)  MISSED
	SDK_UNDEFINED(16,4093) /* FString */               __um(characterName);                                        // 0x0100   (0x0010)  
	int32_t                                            Rank;                                                       // 0x0110   (0x0004)  
	int32_t                                            PipsGainedOrLost;                                           // 0x0114   (0x0004)  
	SDK_UNDEFINED(16,4094) /* FString */               __um(MatchEndReason);                                       // 0x0118   (0x0010)  
	bool                                               IsTutorialBotMatch;                                         // 0x0128   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0129   (0x0007)  MISSED
	SDK_UNDEFINED(16,4095) /* FString */               __um(OnboardingModeId);                                     // 0x0130   (0x0010)  
	int32_t                                            OnboardingEnabled;                                          // 0x0140   (0x0004)  
	int32_t                                            OnboardingABTestingEnabled;                                 // 0x0144   (0x0004)  
	int32_t                                            OnboardingNumberActiveModes;                                // 0x0148   (0x0004)  
	int32_t                                            OnboardingNewAssignedMode;                                  // 0x014C   (0x0004)  
	float                                              ExactPing;                                                  // 0x0150   (0x0004)  
	unsigned char                                      UnknownData02_6[0x4];                                       // 0x0154   (0x0004)  MISSED
};

/// Struct /Script/DBDAnalytics.PostGame_KillerAnalytics
/// Size: 0x0090 (0x000158 - 0x0001E8)
struct FPostGame_KillerAnalytics : FPostGameAnalyticsBase
{ 
	int32_t                                            Brutality;                                                  // 0x0158   (0x0004)  
	int32_t                                            Deviousness;                                                // 0x015C   (0x0004)  
	int32_t                                            Hunter;                                                     // 0x0160   (0x0004)  
	int32_t                                            Sacrifice;                                                  // 0x0164   (0x0004)  
	int32_t                                            BrutalityBonus;                                             // 0x0168   (0x0004)  
	int32_t                                            DeviousnessBonus;                                           // 0x016C   (0x0004)  
	int32_t                                            HunterBonus;                                                // 0x0170   (0x0004)  
	int32_t                                            SacrificeBonus;                                             // 0x0174   (0x0004)  
	int32_t                                            EscapeesCount;                                              // 0x0178   (0x0004)  
	int32_t                                            SacrificedCount;                                            // 0x017C   (0x0004)  
	int32_t                                            KilledCount;                                                // 0x0180   (0x0004)  
	int32_t                                            DisconnectCount;                                            // 0x0184   (0x0004)  
	int32_t                                            BotCount;                                                   // 0x0188   (0x0004)  
	int32_t                                            TimeOpenGate;                                               // 0x018C   (0x0004)  
	SDK_UNDEFINED(16,4096) /* FString */               __um(SurvivorSpawningPosition);                             // 0x0190   (0x0010)  
	int32_t                                            GeneratorsDone;                                             // 0x01A0   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x01A4   (0x0004)  MISSED
	SDK_UNDEFINED(16,4097) /* FString */               __um(EGS_starter);                                          // 0x01A8   (0x0010)  
	float                                              EGS_time;                                                   // 0x01B8   (0x0004)  
	float                                              EGS_duration;                                               // 0x01BC   (0x0004)  
	int32_t                                            EGS_sacrifice;                                              // 0x01C0   (0x0004)  
	bool                                               EGS_reachEnd;                                               // 0x01C4   (0x0001)  
	bool                                               UsedController;                                             // 0x01C5   (0x0001)  
	bool                                               UsedKeyboard;                                               // 0x01C6   (0x0001)  
	unsigned char                                      UnknownData01_5[0x1];                                       // 0x01C7   (0x0001)  MISSED
	float                                              GeneratorRepairTimestamp1;                                  // 0x01C8   (0x0004)  
	float                                              GeneratorRepairTimestamp2;                                  // 0x01CC   (0x0004)  
	float                                              GeneratorRepairTimestamp3;                                  // 0x01D0   (0x0004)  
	float                                              GeneratorRepairTimestamp4;                                  // 0x01D4   (0x0004)  
	float                                              GeneratorRepairTimestamp5;                                  // 0x01D8   (0x0004)  
	int32_t                                            GeneratorsMaxRegressionCount;                               // 0x01DC   (0x0004)  
	int32_t                                            GeneratorKicksCount;                                        // 0x01E0   (0x0004)  
	bool                                               UsedHapticsVibration;                                       // 0x01E4   (0x0001)  
	unsigned char                                      UnknownData02_6[0x3];                                       // 0x01E5   (0x0003)  MISSED
};
...
{ 
	int32_t                                            Objectives;                                                 // 0x0158   (0x0004)  
	int32_t                                            Survival;                                                   // 0x015C   (0x0004)  
	int32_t                                            Altruism;                                                   // 0x0160   (0x0004)  
	int32_t                                            Boldness;                                                   // 0x0164   (0x0004)  
	int32_t                                            ObjectivesBonus;                                            // 0x0168   (0x0004)  
	int32_t                                            SurvivalBonus;                                              // 0x016C   (0x0004)  
	int32_t                                            AltruismBonus;                                              // 0x0170   (0x0004)  
	int32_t                                            BoldnessBonus;                                              // 0x0174   (0x0004)  
	SDK_UNDEFINED(16,4098) /* FString */               __um(Outcome);                                              // 0x0178   (0x0010)  
	ECamperDamageState                                 damageState;                                                // 0x0188   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0189   (0x0003)  MISSED
	int32_t                                            HookedCount;                                                // 0x018C   (0x0004)  
	int32_t                                            RepairCanceledBeforeRegressionStoppedCount;                 // 0x0190   (0x0004)  
	bool                                               UsedController;                                             // 0x0194   (0x0001)  
	bool                                               UsedKeyboard;                                               // 0x0195   (0x0001)  
	bool                                               UsedHapticsVibration;                                       // 0x0196   (0x0001)  
	unsigned char                                      UnknownData01_6[0x1];                                       // 0x0197   (0x0001)  MISSED
};
...
{ 
	SDK_UNDEFINED(16,4099) /* FString */               __um(Type);                                                 // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,4100) /* FString */               __um(ID);                                                   // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4101) /* FString */               __um(characterName);                                        // 0x00B8   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,4102) /* FString */               __um(MapName);                                              // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,4103) /* FString */               __um(Procedural_MeatLocker_Small);                          // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,4104) /* FString */               __um(Procedural_MeatLocker_Big);                            // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,4105) /* FString */               __um(Procedural_Searchable);                                // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,4106) /* FString */               __um(Procedural_EdgeObjects);                               // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,4107) /* FString */               __um(Procedural_LivingWorldObjects);                        // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,4108) /* FString */               __um(Procedural_Hatch);                                     // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,4109) /* FString */               __um(Procedural_BookShelves);                               // 0x0130   (0x0010)  
	SDK_UNDEFINED(16,4110) /* FString */               __um(Procedural_BreakableWalls);                            // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,4111) /* FString */               __um(Procedural_Totems);                                    // 0x0150   (0x0010)  
	SDK_UNDEFINED(16,4112) /* FString */               __um(Procedural_QuadrantSpawn);                             // 0x0160   (0x0010)  
	...
	SDK_UNDEFINED(16,4113) /* FString */               __um(KillerSpawn);                                          // 0x0190   (0x0010)  
	SDK_UNDEFINED(16,4114) /* FString */               __um(SurvivorSpawn);                                        // 0x01A0   (0x0010)  
	SDK_UNDEFINED(16,4115) /* FString */               __um(MatchID);                                              // 0x01B0   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4116) /* FString */               __um(ClientIdTransmitter);                                  // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4117) /* FString */               __um(ClientIdReceiver);                                     // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4118) /* FString */               __um(MirrorsIdTransmitter);                                 // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,4119) /* FString */               __um(MirrorsIdReceiver);                                    // 0x00E8   (0x0010)  
	...
	SDK_UNDEFINED(16,4120) /* FString */               __um(MatchID);                                              // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,4121) /* FString */               __um(GameMode);                                             // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,4122) /* FString */               __um(ReportType);                                           // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,4123) /* FString */               __um(ReportCategory);                                       // 0x0130   (0x0010)  
	SDK_UNDEFINED(16,4124) /* FString */               __um(Comments);                                             // 0x0140   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4125) /* FString */               __um(Sender);                                               // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4126) /* FString */               __um(SenderPlatform);                                       // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4127) /* FString */               __um(MatchID);                                              // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,4128) /* FString */               __um(MatchType);                                            // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,4129) /* FString */               __um(Role);                                                 // 0x00F8   (0x0010)  
	int32_t                                            characterId;                                                // 0x0108   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x010C   (0x0004)  MISSED
	SDK_UNDEFINED(16,4130) /* FString */               __um(characterName);                                        // 0x0110   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4131) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,4132) /* FString */               __um(GameState);                                            // 0x0128   (0x0010)  
	TArray<FNamedRPCCount>                             AllNamedCounts;                                             // 0x0138   (0x0010)  
	int64_t                                            TotalCount;                                                 // 0x0148   (0x0008)  
	SDK_UNDEFINED(16,4133) /* TArray<FString> */       __um(UnlistedNames);                                        // 0x0150   (0x0010)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00BC   (0x0004)  MISSED
	SDK_UNDEFINED(16,4134) /* FString */               __um(ErrorMessage);                                         // 0x00C0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4135) /* FString */               __um(RTMType);                                              // 0x00B8   (0x0010)  
	uint32_t                                           RTMSize;                                                    // 0x00C8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00CC   (0x0004)  MISSED
	SDK_UNDEFINED(16,4136) /* FString */               __um(CurrentGameFlowStep);                                  // 0x00D0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4137) /* FString */               __um(URL);                                                  // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4138) /* FString */               __um(Verb);                                                 // 0x00C8   (0x0010)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00BC   (0x0004)  MISSED
	SDK_UNDEFINED(16,4139) /* FString */               __um(ContentType);                                          // 0x00C0   (0x0010)  
	float                                              ElapsedTime;                                                // 0x00D0   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00D4   (0x0004)  MISSED
	SDK_UNDEFINED(16,4140) /* FString */               __um(Status);                                               // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,4141) /* FString */               __um(URL);                                                  // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,4142) /* FString */               __um(Verb);                                                 // 0x00F8   (0x0010)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x00B9   (0x0007)  MISSED
	SDK_UNDEFINED(16,4143) /* FString */               __um(Message);                                              // 0x00C0   (0x0010)  
};
...
{ 
	int32_t                                            ErrorCode;                                                  // 0x00B8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00BC   (0x0004)  MISSED
	SDK_UNDEFINED(16,4144) /* FString */               __um(category);                                             // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,4145) /* FString */               __um(ErrorDetails);                                         // 0x00D0   (0x0010)  
	uint32_t                                           KrakenErrorCode;                                            // 0x00E0   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00E4   (0x0004)  MISSED
	SDK_UNDEFINED(16,4146) /* FString */               __um(StateName);                                            // 0x00E8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4147) /* FString */               __um(OwnedPerks);                                           // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4148) /* FString */               __um(PlayerStatsProgression);                               // 0x00C8   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,4149) /* TMap<FName, int32_t> */  __um(Perks);                                                // 0x0000   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,4150) /* FString */               __um(ScorerMirrorsId);                                      // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4151) /* FString */               __um(TargetMirrorsId);                                      // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4152) /* FString */               __um(MatchID);                                              // 0x00D8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4153) /* FString */               __um(MatchID);                                              // 0x00B8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4154) /* FString */               __um(LogMessage);                                           // 0x00B8   (0x0010)  
};
...
{ 
	EPlayerRole                                        Role;                                                       // 0x00B8   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x00B9   (0x0007)  MISSED
	SDK_UNDEFINED(16,4155) /* FString */               __um(MatchID);                                              // 0x00C0   (0x0010)  
...
struct FStat
{ 
	SDK_UNDEFINED(16,4156) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
...
struct FCounter
{ 
	SDK_UNDEFINED(16,4157) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
	float                                              FloatValue;                                                 // 0x0010   (0x0004)  
	float                                              FloatValueMin;                                              // 0x0014   (0x0004)  
	float                                              FloatValueMax;                                              // 0x0018   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x001C   (0x0004)  MISSED
...
struct FMemoryStat
{ 
	SDK_UNDEFINED(16,4158) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
	float                                              FloatValue;                                                 // 0x0010   (0x0004)  
	float                                              FloatValueMin;                                              // 0x0014   (0x0004)  
	float                                              FloatValueMax;                                              // 0x0018   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x001C   (0x0004)  MISSED
...
{ 
	SDK_UNDEFINED(16,4159) /* FString */               __um(Name);                                                 // 0x00B8   (0x0010)  
	bool                                               bIsBudget;                                                  // 0x00C8   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x00C9   (0x0007)  MISSED
	SDK_UNDEFINED(16,4160) /* FString */               __um(MatchID);                                              // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,4161) /* FString */               __um(MapName);                                              // 0x00E0   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,4162) /* FString */               __um(tutorialId);                                           // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,4163) /* FString */               __um(OnboardingModeId);                                     // 0x00F8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4164) /* FString */               __um(AssetName);                                            // 0x00B8   (0x0010)  
	float                                              LoadTimeMilliseconds;                                       // 0x00C8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00CC   (0x0004)  MISSED
	SDK_UNDEFINED(16,4165) /* FString */               __um(DeviceProfileName);                                    // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,4166) /* FString */               __um(BuildConfiguration);                                   // 0x00E0   (0x0010)  
	int32_t                                            ChangelistNumber;                                           // 0x00F0   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00F4   (0x0004)  MISSED
	SDK_UNDEFINED(16,4167) /* FString */               __um(MapName);                                              // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,4168) /* FString */               __um(GameFlowContext);                                      // 0x0108   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4169) /* FString */               __um(texturegroup_name);                                    // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4170) /* FString */               __um(texturegroups_guid);                                   // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4171) /* FString */               __um(map_name);                                             // 0x00D8   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4172) /* FString */               __um(TransactionType);                                      // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4173) /* FString */               __um(TransactionSource);                                    // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,4174) /* FString */               __um(SourceID);                                             // 0x00D8   (0x0010)  
	int32_t                                            SourceTier;                                                 // 0x00E8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00EC   (0x0004)  MISSED
	SDK_UNDEFINED(16,4175) /* FString */               __um(CurrencyType);                                         // 0x00F0   (0x0010)  
	...
	SDK_UNDEFINED(16,4176) /* FString */               __um(ItemIDAcquired);                                       // 0x0110   (0x0010)  
	int32_t                                            Rank;                                                       // 0x0120   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x0124   (0x0004)  MISSED
	SDK_UNDEFINED(16,4177) /* FString */               __um(SelectedCharacter);                                    // 0x0128   (0x0010)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00BC   (0x0004)  MISSED
	SDK_UNDEFINED(16,4178) /* TArray<FString> */       __um(PlatformResults);                                      // 0x00C0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4179) /* FString */               __um(EnteredSequence);                                      // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,4180) /* FString */               __um(ExpectedSequence);                                     // 0x00C8   (0x0010)  
