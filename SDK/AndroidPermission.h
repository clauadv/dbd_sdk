...
{ 
public:
	SDK_UNDEFINED(16,3439) /* FMulticastInlineDelegate */ __um(OnPermissionsGrantedDynamicDelegate);               // 0x0030   (0x0010)  
...
public:
	...
	// bool CheckPermission(FString permission);                                                                             // [0x4d204f0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AndroidPermission.AndroidPermissionFunctionLibrary.AcquirePermissions
	// class UAndroidPermissionCallbackProxy* AcquirePermissions(TArray<FString>& Permissions);                              // [0x4d20420] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
