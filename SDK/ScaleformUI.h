...
{ 
	SDK_UNDEFINED(16,1698) /* FString */               __um(Resource);                                             // 0x0000   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,1699) /* FString */               __um(SwfAssetName);                                         // 0x0038   (0x0010)  
	...
	SDK_UNDEFINED(1,1700) /* TEnumAsByte<GFxHitTestType> */ __um(HitTestType);                                     // 0x0054   (0x0001)  
	...
	SDK_UNDEFINED(1,1701) /* TEnumAsByte<EGFxRenderTextureMode> */ __um(RenderTextureMode);                        // 0x0098   (0x0001)  
	...
	SDK_UNDEFINED(16,1702) /* FMulticastInlineDelegate */ __um(OnFsCommand);                                       // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,1703) /* FMulticastInlineDelegate */ __um(OnStartCommand);                                    // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,1704) /* FMulticastInlineDelegate */ __um(OnCloseCommand);                                    // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,1705) /* FMulticastInlineDelegate */ __um(OnTickCommand);                                     // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,1706) /* FMulticastInlineDelegate */ __um(OnFocusGainedCommand);                              // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,1707) /* FMulticastInlineDelegate */ __um(OnFocusLostCommand);                                // 0x0108   (0x0010)  
	...
	// bool Start(bool bRefresh);                                                                                            // [0x75b0450] Native|Public        
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetVisibility
	// void SetVisibility(FString MovieClipName, bool bVisible);                                                             // [0x75b02d0] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetViewScaleMode
	// void SetViewScaleMode(TEnumAsByte<EGFxScaleMode> ScaleMode);                                                          // [0x75b0100] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetViewport
	// void SetViewport(int32_t X, int32_t Y, int32_t Width, int32_t Height);                                                // [0x75b0180] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetView3D
	// void SetView3D(FTransform& ViewTransform);                                                                            // [0x75b0020] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetVariableValueArray
	// void SetVariableValueArray(FString MovieClipName, FString MemberName, TArray<FASValue>& value);                       // [0x75afe80] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetVariableValue
	// void SetVariableValue(FString MovieClipName, FString MemberName, FASValue& value);                                    // [0x75afcf0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetTimingMode
	// void SetTimingMode(TEnumAsByte<EGFxTimingMode> TimingMode);                                                           // [0x75afc70] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetScale
	// void SetScale(FString MovieClipName, float XScale, float YScale);                                                     // [0x75afa70] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetPosition
	// void SetPosition(FString MovieClipName, float X, float Y);                                                            // [0x75af870] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetPerspective3D
	// void SetPerspective3D(FASPerspectiveTransform& PerspectiveTransform);                                                 // [0x75af7c0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetPause
	// void SetPause(bool bPausePlayback);                                                                                   // [0x75af730] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetMovieCanReceiveInput
	// void SetMovieCanReceiveInput(bool bCanReceiveInput);                                                                  // [0x75af6a0] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetMovieCanReceiveFocus
	// void SetMovieCanReceiveFocus(bool bCanReceiveFocus);                                                                  // [0x75af610] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetFocusIgnoreKeys
	// void SetFocusIgnoreKeys(TArray<FKey>& Keys);                                                                          // [0x75af260] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetExternalTexture
	// bool SetExternalTexture(FString Resource, class UTexture* Texture);                                                   // [0x75af160] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetDisplayTransform
	// void SetDisplayTransform(FString MovieClipName, FTransform& DisplayTransform);                                        // [0x75aef40] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetDisplayInfo
	// void SetDisplayInfo(FString MovieClipName, FASDisplayInfo& Info);                                                     // [0x75aed60] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetColorTransform
	// void SetColorTransform(FString MovieClipName, FASColorTransform& UnrealColorTransform);                               // [0x75aebc0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetCaptureKeys
	// void SetCaptureKeys(TArray<FKey>& Keys);                                                                              // [0x75aeac0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.SetAlignment
	// void SetAlignment(TEnumAsByte<EGFxAlign> Align);                                                                      // [0x75aea40] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.ReceiveGFxCommand
	// void ReceiveGFxCommand(FString Command, FString Arguments);                                                           // [0x75ae940] Native|Public        
	// Function /Script/ScaleformUI.GFxMoviePlayer.OpenMovie
	// class UGFxMoviePlayer* OpenMovie(class USwfMovie* SwfMovie, class UObject* ExternalScriptInterface, class UTextureRenderTarget2D* RenderToTexture, class UGFxMoviePlayer* MoviePlayer, bool DisplayWithHudOff, bool StartPaused); // [0x75ae770] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.OnTick
	// void OnTick(float DeltaTime);                                                                                         // [0x75ae6e0] Native|Public        
	// Function /Script/ScaleformUI.GFxMoviePlayer.OnStart
	// void OnStart();                                                                                                       // [0x75ae6c0] Native|Public        
	// Function /Script/ScaleformUI.GFxMoviePlayer.OnFocusLost
	// void OnFocusLost(int32_t LocalPlayerIndex);                                                                           // [0x75ae630] Native|Public        
	// Function /Script/ScaleformUI.GFxMoviePlayer.OnFocusGained
	// void OnFocusGained(int32_t LocalPlayerIndex);                                                                         // [0x75ae5a0] Native|Public        
	// Function /Script/ScaleformUI.GFxMoviePlayer.OnClose
	// void OnClose();                                                                                                       // [0x75ae580] Native|Public        
	// Function /Script/ScaleformUI.GFxMoviePlayer.LoadAndStart
	// bool LoadAndStart(FString InSwfAssetName, bool bRefresh);                                                             // [0x75ae430] Native|Public        
	// Function /Script/ScaleformUI.GFxMoviePlayer.Invoke
	// FASValue Invoke(FString MovieClipName, FString FunctionName, TArray<FASValue>& Params);                               // [0x75ae0e0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GotoAndStopI
	// void GotoAndStopI(FString MovieClipName, int32_t Frame);                                                              // [0x75adf70] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GotoAndStop
	// void GotoAndStop(FString MovieClipName, FString Frame);                                                               // [0x75addd0] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GotoAndPlayI
	// void GotoAndPlayI(FString MovieClipName, int32_t Frame);                                                              // [0x75adc60] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GotoAndPlay
	// void GotoAndPlay(FString MovieClipName, FString Frame);                                                               // [0x75adac0] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetVisibility
	// bool GetVisibility(FString MovieClipName);                                                                            // [0x75ad9e0] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetView3D
	// FTransform GetView3D();                                                                                               // [0x75ad970] Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetVariableValueArray
	// TArray<FASValue> GetVariableValueArray(FString MovieClipName, FString MemberName);                                    // [0x75ad810] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetVariableValue
	// FASValue GetVariableValue(FString MovieClipName, FString MemberName);                                                 // [0x75ad6d0] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetScale
	// bool GetScale(FString MovieClipName, float& XScale, float& YScale);                                                   // [0x75ad490] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetPosition
	// bool GetPosition(FString MovieClipName, float& X, float& Y);                                                          // [0x75ad250] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetPerspective3D
	// FASPerspectiveTransform GetPerspective3D();                                                                           // [0x75ad200] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetMovieClip
	// class UGFxObject* GetMovieClip(FString MovieClipName);                                                                // [0x75ad150] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetDisplayTransform
	// FTransform GetDisplayTransform(FString MovieClipName);                                                                // [0x75ace30] Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetDisplayInfo
	// FASDisplayInfo GetDisplayInfo(FString MovieClipName);                                                                 // [0x75acd00] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.GetColorTransform
	// FASColorTransform GetColorTransform(FString MovieClipName);                                                           // [0x75acc00] Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxMoviePlayer.Close
	// void Close(bool Unload);                                                                                              // [0x75acb70] Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetVisible(bool bVisible);                                                                                       // [0x75b03c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.SetScale
	// void SetScale(float XScale, float YScale);                                                                            // [0x75afba0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.SetPosition
	// void SetPosition(float X, float Y);                                                                                   // [0x75af9a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.SetMemberValueArray
	// void SetMemberValueArray(class UGFxMoviePlayer* MoviePlayer, FString MemberName, TArray<FASValue>& Input);            // [0x75af490] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.SetMemberValue
	// void SetMemberValue(FString MemberName, FASValue& Input);                                                             // [0x75af360] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.SetDisplayTransform
	// void SetDisplayTransform(FTransform& DisplayTransform);                                                               // [0x75af080] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.SetDisplayInfo
	// void SetDisplayInfo(FASDisplayInfo& UnrealDisplayInfo);                                                               // [0x75aee80] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.SetColorTransform
	// void SetColorTransform(FASColorTransform& UnrealColorTransform);                                                      // [0x75aecc0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.Invoke
	// FASValue Invoke(FString FunctionName, TArray<FASValue>& Params);                                                      // [0x75ae2b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GotoAndStopI
	// void GotoAndStopI(int32_t FrameNumber);                                                                               // [0x75ae050] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GotoAndStop
	// void GotoAndStop(FString FrameString);                                                                                // [0x75aded0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GotoAndPlayI
	// void GotoAndPlayI(int32_t FrameNumber);                                                                               // [0x75add40] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GotoAndPlay
	// void GotoAndPlay(FString FrameString);                                                                                // [0x75adbc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GetVisible
	// bool GetVisible();                                                                                                    // [0x75ada90] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GetScale
	// bool GetScale(float& XScale, float& YScale);                                                                          // [0x75ad5e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GetPosition
	// bool GetPosition(float& X, float& Y);                                                                                 // [0x75ad3a0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GetMemberValueArray
	// TArray<FASValue> GetMemberValueArray(FString MemberName);                                                             // [0x75ad050] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GetMemberValue
	// FASValue GetMemberValue(FString MemberName);                                                                          // [0x75acf70] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GetDisplayTransform
	// FTransform GetDisplayTransform();                                                                                     // [0x75acf10] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GetDisplayInfo
	// FASDisplayInfo GetDisplayInfo();                                                                                      // [0x75acde0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.GFxObject.GetColorTransform
	// FASColorTransform GetColorTransform();                                                                                // [0x75accc0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UGFxMoviePlayer* OpenMovie(class USwfMovie* Movie, class UObject* ExternalInterface, class UTextureRenderTarget2D* RenderTexture, class UGFxMoviePlayer* MoviePlayer, bool DisplayWithHudOff, bool StartPaused); // [0x75b0e00] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.ScaleformBlueprintLibrary.InvokeNoParams
	// FASValue InvokeNoParams(class UGFxMoviePlayer* MoviePlayer, FString FunctionName);                                    // [0x75b0c90] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.ScaleformBlueprintLibrary.Invoke
	// FASValue Invoke(class UGFxMoviePlayer* MoviePlayer, FString FunctionName, TArray<FASValue>& Params);                  // [0x75b0aa0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ScaleformUI.ScaleformBlueprintLibrary.GetVariable
	// class UGFxObject* GetVariable(class UGFxMoviePlayer* MoviePlayer, FString VariablePath);                              // [0x75b09c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.ScaleformBlueprintLibrary.GetMovieClip
	// class UGFxObject* GetMovieClip(class UGFxMoviePlayer* MoviePlayer, FString MovieClipName);                            // [0x75b09c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.ScaleformBlueprintLibrary.GetMember
	// class UGFxObject* GetMember(class UGFxMoviePlayer* MoviePlayer, FString MemberName);                                  // [0x75b09c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/ScaleformUI.ScaleformBlueprintLibrary.CloseMovie
	// void CloseMovie(class UGFxMoviePlayer* MoviePlayer);                                                                  // [0x75b0940] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(1,1708) /* TEnumAsByte<FlashTextureRescale> */ __um(TextureRescale);                             // 0x003C   (0x0001)  
	unsigned char                                      UnknownData02_5[0x3];                                       // 0x003D   (0x0003)  MISSED
	SDK_UNDEFINED(16,1709) /* FString */               __um(TextureFormat);                                        // 0x0040   (0x0010)  
	bool                                               bReplaceImages : 1;                                         // 0x0050:0 (0x0001)  
	unsigned char                                      UnknownData03_4[0x7];                                       // 0x0051   (0x0007)  MISSED
	SDK_UNDEFINED(16,1710) /* FString */               __um(SourceFile);                                           // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,1711) /* TArray<FString> */       __um(FontMappings);                                         // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,1712) /* FString */               __um(SourceFileTimestamp);                                  // 0x0078   (0x0010)  
	uint64_t                                           ImportTimeStamp;                                            // 0x0088   (0x0008)  
	TArray<char>                                       RawData;                                                    // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,1713) /* TArray<FString> */       __um(ReferencedAssetNames);                                 // 0x00A0   (0x0010)  
...
struct FASValue
{ 
	SDK_UNDEFINED(1,1714) /* TEnumAsByte<EASType> */   __um(ASType);                                               // 0x0000   (0x0001)  
	bool                                               ASBoolean;                                                  // 0x0001   (0x0001)  
	unsigned char                                      UnknownData00_5[0x2];                                       // 0x0002   (0x0002)  MISSED
	int32_t                                            ASInt;                                                      // 0x0004   (0x0004)  
	float                                              ASNumber;                                                   // 0x0008   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x000C   (0x0004)  MISSED
	SDK_UNDEFINED(16,1715) /* FString */               __um(ASString);                                             // 0x0010   (0x0010)  
