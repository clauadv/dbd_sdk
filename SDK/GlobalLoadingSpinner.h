...
/// Class /DBDUICore/GlobalLoadingSpinner/WBP_GlobalLoadingSpinnerWidget.WBP_GlobalLoadingSpinnerWidget_C
/// Size: 0x0010 (0x000318 - 0x000328)
class UWBP_GlobalLoadingSpinnerWidget_C : public UCoreGlobalLoadingSpinnerWidget
{ 
public:
	FPointerToUberGraphFrame                           UberGraphFrame;                                             // 0x0318   (0x0008)  
	class UWBP_LoadingSmall_C*                         LoadingSpinner;                                             // 0x0320   (0x0008)  
