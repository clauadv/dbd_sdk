...
{ 
	SDK_UNDEFINED(16,4606) /* FString */               __um(Text);                                                 // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,4607) /* FString */               __um(UserName);                                             // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4608) /* FString */               __um(Command);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,4609) /* FString */               __um(UserName);                                             // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4610) /* FString */               __um(UserName);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,4611) /* FString */               __um(UserToGrant);                                          // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4612) /* FString */               __um(UserName);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,4613) /* FString */               __um(UserToDeny);                                           // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,4614) /* FString */               __um(CurrentLevel);                                         // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(16,4615) /* FString */               __um(InstanceType);                                         // 0x0028   (0x0010)  
