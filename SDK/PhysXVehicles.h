...
{ 
	...
	FVector                                            AdditionalOffset;                                           // 0x0014   (0x000C)  
	bool                                               bDisableSteering;                                           // 0x0020   (0x0001)  
...
/// Size: 0x0158 (0x000148 - 0x0002A0)
class UWheeledVehicleMovementComponent : public UPawnMovementComponent
{ 
public:
	unsigned char                                      UnknownData00_2[0x8];                                       // 0x0148   (0x0008)  MISSED
	bool                                               bDeprecatedSpringOffsetMode : 1;                            // 0x0150:0 (0x0001)  
	bool                                               bReverseAsBrake : 1;                                        // 0x0150:1 (0x0001)  
	bool                                               bUseRVOAvoidance : 1;                                       // 0x0150:2 (0x0001)  
	bool                                               bRawHandbrakeInput : 1;                                     // 0x0150:3 (0x0001)  
	bool                                               bRawGearUpInput : 1;                                        // 0x0150:4 (0x0001)  
	bool                                               bRawGearDownInput : 1;                                      // 0x0150:5 (0x0001)  
	unsigned char                                      UnknownData01_3[0x3];                                       // 0x0151   (0x0003)  MISSED
	bool                                               bWasAvoidanceUpdated : 1;                                   // 0x0154:0 (0x0001)  
	unsigned char                                      UnknownData02_4[0x3];                                       // 0x0155   (0x0003)  MISSED
	float                                              Mass;                                                       // 0x0158   (0x0004)  
	unsigned char                                      UnknownData03_5[0x4];                                       // 0x015C   (0x0004)  MISSED
	TArray<FWheelSetup>                                WheelSetups;                                                // 0x0160   (0x0010)  
	float                                              DragCoefficient;                                            // 0x0170   (0x0004)  
	float                                              ChassisWidth;                                               // 0x0174   (0x0004)  
	float                                              ChassisHeight;                                              // 0x0178   (0x0004)  
	float                                              DragArea;                                                   // 0x017C   (0x0004)  
	float                                              EstimatedMaxEngineSpeed;                                    // 0x0180   (0x0004)  
	float                                              MaxEngineRPM;                                               // 0x0184   (0x0004)  
	float                                              DebugDragMagnitude;                                         // 0x0188   (0x0004)  
	FVector                                            InertiaTensorScale;                                         // 0x018C   (0x000C)  
	float                                              MinNormalizedTireLoad;                                      // 0x0198   (0x0004)  
	float                                              MinNormalizedTireLoadFiltered;                              // 0x019C   (0x0004)  
	float                                              MaxNormalizedTireLoad;                                      // 0x01A0   (0x0004)  
	float                                              MaxNormalizedTireLoadFiltered;                              // 0x01A4   (0x0004)  
	float                                              ThresholdLongitudinalSpeed;                                 // 0x01A8   (0x0004)  
	int32_t                                            LowForwardSpeedSubStepCount;                                // 0x01AC   (0x0004)  
	int32_t                                            HighForwardSpeedSubStepCount;                               // 0x01B0   (0x0004)  
	unsigned char                                      UnknownData04_5[0x4];                                       // 0x01B4   (0x0004)  MISSED
	TArray<class UVehicleWheel*>                       Wheels;                                                     // 0x01B8   (0x0010)  
	unsigned char                                      UnknownData05_5[0x18];                                      // 0x01C8   (0x0018)  MISSED
	float                                              RVOAvoidanceRadius;                                         // 0x01E0   (0x0004)  
	float                                              RVOAvoidanceHeight;                                         // 0x01E4   (0x0004)  
	float                                              AvoidanceConsiderationRadius;                               // 0x01E8   (0x0004)  
	float                                              RVOSteeringStep;                                            // 0x01EC   (0x0004)  
	float                                              RVOThrottleStep;                                            // 0x01F0   (0x0004)  
	int32_t                                            AvoidanceUID;                                               // 0x01F4   (0x0004)  
	FNavAvoidanceMask                                  AvoidanceGroup;                                             // 0x01F8   (0x0004)  
	FNavAvoidanceMask                                  GroupsToAvoid;                                              // 0x01FC   (0x0004)  
	FNavAvoidanceMask                                  GroupsToIgnore;                                             // 0x0200   (0x0004)  
	float                                              AvoidanceWeight;                                            // 0x0204   (0x0004)  
	FVector                                            PendingLaunchVelocity;                                      // 0x0208   (0x000C)  
	FReplicatedVehicleState                            ReplicatedState;                                            // 0x0214   (0x0014)  
	unsigned char                                      UnknownData06_5[0x4];                                       // 0x0228   (0x0004)  MISSED
	float                                              RawSteeringInput;                                           // 0x022C   (0x0004)  
	float                                              RawThrottleInput;                                           // 0x0230   (0x0004)  
	float                                              RawBrakeInput;                                              // 0x0234   (0x0004)  
	float                                              SteeringInput;                                              // 0x0238   (0x0004)  
	float                                              ThrottleInput;                                              // 0x023C   (0x0004)  
	float                                              BrakeInput;                                                 // 0x0240   (0x0004)  
	float                                              HandbrakeInput;                                             // 0x0244   (0x0004)  
	float                                              IdleBrakeInput;                                             // 0x0248   (0x0004)  
	float                                              StopThreshold;                                              // 0x024C   (0x0004)  
	float                                              WrongDirectionThreshold;                                    // 0x0250   (0x0004)  
	FVehicleInputRate                                  ThrottleInputRate;                                          // 0x0254   (0x0008)  
	FVehicleInputRate                                  BrakeInputRate;                                             // 0x025C   (0x0008)  
	FVehicleInputRate                                  HandbrakeInputRate;                                         // 0x0264   (0x0008)  
	FVehicleInputRate                                  SteeringInputRate;                                          // 0x026C   (0x0008)  
	unsigned char                                      UnknownData07_5[0x24];                                      // 0x0274   (0x0024)  MISSED
	class AController*                                 OverrideController;                                         // 0x0298   (0x0008)  
...
public:
	...
	TArray<FTireConfigMaterialFriction>                TireFrictionScales;                                         // 0x0040   (0x0010)  
...
{ 
public:
	class UStaticMesh*                                 CollisionMesh;                                              // 0x0030   (0x0008)  
	bool                                               bDontCreateShape;                                           // 0x0038   (0x0001)  
	bool                                               bAutoAdjustCollisionSize;                                   // 0x0039   (0x0001)  
	unsigned char                                      UnknownData00_5[0x2];                                       // 0x003A   (0x0002)  MISSED
	FVector                                            Offset;                                                     // 0x003C   (0x000C)  
	float                                              ShapeRadius;                                                // 0x0048   (0x0004)  
	float                                              ShapeWidth;                                                 // 0x004C   (0x0004)  
	float                                              Mass;                                                       // 0x0050   (0x0004)  
	float                                              DampingRate;                                                // 0x0054   (0x0004)  
	float                                              SteerAngle;                                                 // 0x0058   (0x0004)  
	bool                                               bAffectedByHandbrake;                                       // 0x005C   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x005D   (0x0003)  MISSED
	class UTireType*                                   TireType;                                                   // 0x0060   (0x0008)  
	class UTireConfig*                                 TireConfig;                                                 // 0x0068   (0x0008)  
	float                                              LatStiffMaxLoad;                                            // 0x0070   (0x0004)  
	float                                              LatStiffValue;                                              // 0x0074   (0x0004)  
	float                                              LongStiffValue;                                             // 0x0078   (0x0004)  
	float                                              SuspensionForceOffset;                                      // 0x007C   (0x0004)  
	float                                              SuspensionMaxRaise;                                         // 0x0080   (0x0004)  
	...
	class UWheeledVehicleMovementComponent*            VehicleSim;                                                 // 0x00A0   (0x0008)  
	int32_t                                            WheelIndex;                                                 // 0x00A8   (0x0004)  
	float                                              DebugLongSlip;                                              // 0x00AC   (0x0004)  
	float                                              DebugLatSlip;                                               // 0x00B0   (0x0004)  
	float                                              DebugNormalizedTireLoad;                                    // 0x00B4   (0x0004)  
	unsigned char                                      UnknownData04_5[0x4];                                       // 0x00B8   (0x0004)  MISSED
	float                                              DebugWheelTorque;                                           // 0x00BC   (0x0004)  
	float                                              DebugLongForce;                                             // 0x00C0   (0x0004)  
	float                                              DebugLatForce;                                              // 0x00C4   (0x0004)  
	FVector                                            Location;                                                   // 0x00C8   (0x000C)  
	FVector                                            OldLocation;                                                // 0x00D4   (0x000C)  
	FVector                                            Velocity;                                                   // 0x00E0   (0x000C)  
	unsigned char                                      UnknownData05_6[0xC];                                       // 0x00EC   (0x000C)  MISSED
...
public:
	...
	class UWheeledVehicleMovementComponent*            VehicleMovement;                                            // 0x02A0   (0x0008)  
};
...
/// Size: 0x0178 (0x0002A0 - 0x000418)
class UWheeledVehicleMovementComponent4W : public UWheeledVehicleMovementComponent
{ 
public:
	FVehicleEngineData                                 EngineSetup;                                                // 0x02A0   (0x00A0)  
	FVehicleDifferential4WData                         DifferentialSetup;                                          // 0x0340   (0x001C)  
	float                                              AckermannAccuracy;                                          // 0x035C   (0x0004)  
	FVehicleTransmissionData                           TransmissionSetup;                                          // 0x0360   (0x0030)  
	FRuntimeFloatCurve                                 SteeringCurve;                                              // 0x0390   (0x0088)  
};
