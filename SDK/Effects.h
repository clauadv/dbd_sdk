...
public:
	...
	// void ExecuteUbergraph_BP_Effect_Mist(int32_t EntryPoint);                                                             // [0x61c32d0] Final                
};
...
public:
	...
	// void Spawn Niagara Particles Character Dissolve(bool Survivor/Killer, class AActor* Actor, class UCustomizedSkeletalMesh* CustomizedSkeletalMesh, bool In/Out, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void SpawnFootstepKillerVFX(bool Run, bool Left, class ASlasherPlayer* SlasherPlayer, class UObject* __WorldContext); // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.SpawnFootstepVFX
	// void SpawnFootstepVFX(bool Run, bool Left, class ACamperPlayer* CamperCharacter, class UObject* __WorldContext, bool& Bloody Footprints, FName& Footprint Socket, int32_t& Surface Type); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.ManageInteractiveMist
	// void ManageInteractiveMist(class APawn* Pawn, class UActorComponent* MistActor, class UObject* __WorldContext);       // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.MakeCharacter_Visible
	// void MakeCharacter_Visible(class ADBDPlayer* Character, class UObject* __WorldContext);                               // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void MakeCharacter_Invisible(class ADBDPlayer* Character, class UObject* __WorldContext);                             // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.MaskFPV_Visible
	// void MaskFPV_Visible(class ADBDPlayer* Character, class UObject* __WorldContext);                                     // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.MaskFPV_Hidden
	// void MaskFPV_Hidden(class ADBDPlayer* Character, class UObject* __WorldContext);                                      // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// bool Received_NotifyEnd(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation);                  // [0x61c32d0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
...
/// Class /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Campfire01_Winter2017.BP_Campfire01_Winter2017_C
...
public:
	...
	class UPointLightComponent*                        Glow_Switch;                                                // 0x0238   (0x0008)  
	class UDecalComponent*                             Decal_BurningWood;                                          // 0x0240   (0x0008)  
	class UPointLightComponent*                        Camp_PointLight_Atlanta;                                    // 0x0248   (0x0008)  
	class USpotLightComponent*                         SmokFill;                                                   // 0x0250   (0x0008)  
	class UPointLightComponent*                        FireCore;                                                   // 0x0258   (0x0008)  
	class UPointLightComponent*                        Glow;                                                       // 0x0260   (0x0008)  
	class USceneComponent*                             Light_LF;                                                   // 0x0268   (0x0008)  
	class USpotLightComponent*                         FireFill;                                                   // 0x0270   (0x0008)  
	class UStaticMeshComponent*                        SM_FirePit01;                                               // 0x0278   (0x0008)  
	class UStaticMeshComponent*                        SM_Campfire01;                                              // 0x0280   (0x0008)  
	class UAkComponent*                                Ak_Audio_Campfire;                                          // 0x0288   (0x0008)  
	class UChildActorComponent*                        Flashing_Light;                                             // 0x0290   (0x0008)  
	class USceneComponent*                             Root;                                                       // 0x0298   (0x0008)  
	float                                              Timeline_0_Brightness_F6CFF7B64AAFDF23887EF1B9155160A5;     // 0x02A0   (0x0004)  
	SDK_UNDEFINED(1,4099) /* TEnumAsByte<ETimelineDirection> */ __um(Timeline_0__Direction_F6CFF7B64AAFDF23887EF1B9155160A5); // 0x02A4   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x02A5   (0x0003)  MISSED
	class UTimelineComponent*                          Timeline;                                                   // 0x02A8   (0x0008)  


	/// Functions
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Campfire01_Winter2017.BP_Campfire01_Winter2017_C.Timeline_0__FinishedFunc
	// void Timeline_0__FinishedFunc();                                                                                      // [0x61c32d0] BlueprintEvent       
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Campfire01_Winter2017.BP_Campfire01_Winter2017_C.Timeline_0__UpdateFunc
	// void Timeline_0__UpdateFunc();                                                                                        // [0x61c32d0] BlueprintEvent       
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Campfire01_Winter2017.BP_Campfire01_Winter2017_C.ReceiveBeginPlay
	// void ReceiveBeginPlay();                                                                                              // [0x61c32d0] Event|Protected|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Campfire01_Winter2017.BP_Campfire01_Winter2017_C.ReceiveTick
	// void ReceiveTick(float DeltaSeconds);                                                                                 // [0x61c32d0] Event|Public|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Campfire01_Winter2017.BP_Campfire01_Winter2017_C.OnBankLoaded
	// void OnBankLoaded(EAkResult Result);                                                                                  // [0x61c32d0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Campfire01_Winter2017.BP_Campfire01_Winter2017_C.ExecuteUbergraph_BP_Campfire01_Winter2017
	// void ExecuteUbergraph_BP_Campfire01_Winter2017(int32_t EntryPoint);                                                   // [0x61c32d0] Final|HasDefaults    
};
...
public:
	...
	// void K13_FX_Mori_SpawnPoseableMesh(bool First Time to Mori);                                                          // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_K13_Killer.BPI_K13_Killer_C.K13_FX_Mori_ResetVariable
	// void K13_FX_Mori_ResetVariable();                                                                                     // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_K13_Killer.BPI_K13_Killer_C.K13_FX_Vault_SpawnPoseableMesh
	// void K13_FX_Vault_SpawnPoseableMesh();                                                                                // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_K13_Killer.BPI_K13_Killer_C.K13_FX_CarryAttack_WeaponDisappear
	// void K13_FX_CarryAttack_WeaponDisappear();                                                                            // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_K13_Killer.BPI_K13_Killer_C.K13_FX_CarryAttack_BOW
	// void K13_FX_CarryAttack_BOW();                                                                                        // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void K13_FX_MakeSwordNotVisible_Attack_Wipe_FPV();                                                                    // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ResetChargeVFX();                                                                                                // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_K13_Killer.BPI_K13_Killer_C.TriggerActivePhaseChargeVFX
	// void TriggerActivePhaseChargeVFX(float chargeTime);                                                                   // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void ExecuteUbergraph_BP_VFX_Slasher_13_AnimNotifies_Handler(int32_t EntryPoint);                                     // [0x61c32d0] Final                
};
...
public:
	...
	// bool HandleKillerNotifies_Trickster(FName Selection, class ASlasherPlayer* MySlasher, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Blight(class ASlasherPlayer* My Slasher1, class UObject* __WorldContext);                   // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Deathslinger(class ASlasherPlayer* My Slasher1, FName Selection, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Oni(class UObject* Target, class UObject* Get Killer1, FName Selection, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Demogorgon(FName Selection, class UObject* Target, class UObject* __WorldContext);          // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Nurse(FName Selection, class ASlasherPlayer* My Slasher1, class UObject* __WorldContext);   // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Hag(FName Selection, class ASlasherPlayer* My Slasher1, class UObject* __WorldContext);     // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void HandleKillerNotifies_Trapper(class UObject* __WorldContext);                                                     // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_General(class ASlasherPlayer* My Slasher1, FName Selection, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void HandleKillerNotifies_WallBreak(FName Selection, class UObject* WorldContextObject, class UObject* __WorldContext, bool& Return Value); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Footsteps(FName Selection, class ASlasherPlayer* Slasher, class UObject* __WorldContext);   // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	SDK_UNDEFINED(1,4100) /* TEnumAsByte<ETimelineDirection> */ __um(TML_PP_IdleInterrupt_02__Direction_A015685E4996C78ADD577788FC36D84F); // 0x024C   (0x0001)  
	...
	// void TML_PP_IdleInterrupt_02__FinishedFunc();                                                                         // [0x61c32d0] BlueprintEvent       
	...
	// void TML_PP_IdleInterrupt_02__UpdateFunc();                                                                           // [0x61c32d0] BlueprintEvent       
	...
	// void Destroy_PP_IdleInterrupt_02();                                                                                   // [0x61c32d0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_k27_MenuIdleInterrupt_02(int32_t EntryPoint);                                                // [0x61c32d0] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_BP_k27_IdleInterrupt_01(int32_t EntryPoint);                                                    // [0x61c32d0] Final                
};
...
public:
	...
	SDK_UNDEFINED(1,4101) /* TEnumAsByte<ETimelineDirection> */ __um(Fade__Direction_5487A9754B5AE15B4E9D0F8644A2CE40); // 0x0274   (0x0001)  
	...
	// void Fade__FinishedFunc();                                                                                            // [0x61c32d0] BlueprintEvent       
	...
	// void Fade__UpdateFunc();                                                                                              // [0x61c32d0] BlueprintEvent       
	...
	// void Fade__RemoveVFX__EventFunc();                                                                                    // [0x61c32d0] BlueprintEvent       
	...
	// void HideHusk();                                                                                                      // [0x61c32d0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_Effect_K27_AfterImage_01(int32_t EntryPoint);                                                // [0x61c32d0] Final                
};
...
public:
	...
	// FTransform GetDecalTransform(class USceneComponent* Mesh, class UObject* __WorldContext);                             // [0x61c32d0] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.SpawnBleedEffect
	// void SpawnBleedEffect(class USceneComponent* Mesh, class UObject* __WorldContext, class UParticleSystemComponent*& ParticleSystem); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.SpawnBloodSpurtsParticles
	// class UNiagaraComponent* SpawnBloodSpurtsParticles(class USceneComponent* Mesh, class UObject* __WorldContext);       // [0x61c32d0] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.GetSlasherBloodOpacityPlayrate
	// float GetSlasherBloodOpacityPlayrate(class UObject* __WorldContext);                                                  // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.GetBloodFramePlayRate
	// float GetBloodFramePlayRate(class UObject* __WorldContext);                                                           // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.CreatePP_BloodMaterial
	// void CreatePP_BloodMaterial(class UObject* __WorldContext, class UMaterialInstanceDynamic*& PostProcessMaterialInstance); // [0x61c32d0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.ManagePostProcessParameters
	// void ManagePostProcessParameters(bool Add/Remove, class UCameraComponent* Camera, class UObject* PostProcessMaterial, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.RandomizeBloodPostProcess
	// void RandomizeBloodPostProcess(class UMaterialInstanceDynamic* MaterialInstance, class ADBDPlayer* DBDPlayer, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.RandomizeBloodLayer
	// void RandomizeBloodLayer(class UMaterialInstanceDynamic* MaterialInstance, FName OffsetX_MaterialParameter, FName OffsetY_MaterialParameter, FName Texture_MaterialParameter, FName Scale_Parameter, int32_t Dimension 1, class UObject* __WorldContext); // [0x61c32d0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
};

/// Class /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Fire_LobbyWinter.BP_Fire_LobbyWinter_C
/// Size: 0x001C (0x000230 - 0x00024C)
class ABP_Fire_LobbyWinter_C : public AActor
{ 
public:
	FPointerToUberGraphFrame                           UberGraphFrame;                                             // 0x0230   (0x0008)  
	class UParticleSystemComponent*                    P_Fire;                                                     // 0x0238   (0x0008)  
	class USceneComponent*                             DefaultSceneRoot;                                           // 0x0240   (0x0008)  
	float                                              TotalTime;                                                  // 0x0248   (0x0004)  


	/// Functions
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Fire_LobbyWinter.BP_Fire_LobbyWinter_C.Fire_Smoke
	// void Fire_Smoke(class UParticleSystemComponent* FX, bool Smoke);                                                      // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Fire_LobbyWinter.BP_Fire_LobbyWinter_C.Fire_Normal
	// void Fire_Normal(class UParticleSystemComponent* FX, bool Normal);                                                    // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Fire_LobbyWinter.BP_Fire_LobbyWinter_C.Spawn
	// void Spawn(class UParticleSystemComponent* Spawn, float Smoke1, float Smoke2, float F_Smoke2, float Fire0, float F_Fire0, float Flames1, float Flames2, float Flames3, float F_Flames1, float F_Flames2, float F_Flames3); // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Fire_LobbyWinter.BP_Fire_LobbyWinter_C.ReceiveBeginPlay
	// void ReceiveBeginPlay();                                                                                              // [0x61c32d0] Event|Protected|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Fire_LobbyWinter.BP_Fire_LobbyWinter_C.ReceiveTick
	// void ReceiveTick(float DeltaSeconds);                                                                                 // [0x61c32d0] Event|Public|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Fire_LobbyWinter.BP_Fire_LobbyWinter_C.ExecuteUbergraph_BP_Fire_LobbyWinter
	// void ExecuteUbergraph_BP_Fire_LobbyWinter(int32_t EntryPoint);                                                        // [0x61c32d0] Final                
};
...
/// Class /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Effect_FlashingLight_LobbyWinter.BP_Effect_FlashingLight_LobbyWinter_C
/// Size: 0x0020 (0x000230 - 0x000250)
class ABP_Effect_FlashingLight_LobbyWinter_C : public AActor
{ 
public:
	FPointerToUberGraphFrame                           UberGraphFrame;                                             // 0x0230   (0x0008)  
	class UChildActorComponent*                        BP_Fire_LobbyWinter;                                        // 0x0238   (0x0008)  
	float                                              Timeline_0_Brightness_36CBBAF743AFC4CFB888D59AD4CD8486;     // 0x0240   (0x0004)  
	SDK_UNDEFINED(1,4102) /* TEnumAsByte<ETimelineDirection> */ __um(Timeline_0__Direction_36CBBAF743AFC4CFB888D59AD4CD8486); // 0x0244   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0245   (0x0003)  MISSED
	class UTimelineComponent*                          Timeline;                                                   // 0x0248   (0x0008)  


	/// Functions
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Effect_FlashingLight_LobbyWinter.BP_Effect_FlashingLight_LobbyWinter_C.Timeline_0__FinishedFunc
	// void Timeline_0__FinishedFunc();                                                                                      // [0x61c32d0] BlueprintEvent       
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Effect_FlashingLight_LobbyWinter.BP_Effect_FlashingLight_LobbyWinter_C.Timeline_0__UpdateFunc
	// void Timeline_0__UpdateFunc();                                                                                        // [0x61c32d0] BlueprintEvent       
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Effect_FlashingLight_LobbyWinter.BP_Effect_FlashingLight_LobbyWinter_C.ReceiveBeginPlay
	// void ReceiveBeginPlay();                                                                                              // [0x61c32d0] Event|Protected|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Environment/Lobby/Winter/BP_Effect_FlashingLight_LobbyWinter.BP_Effect_FlashingLight_LobbyWinter_C.ExecuteUbergraph_BP_Effect_FlashingLight_LobbyWinter
	// void ExecuteUbergraph_BP_Effect_FlashingLight_LobbyWinter(int32_t EntryPoint);                                        // [0x61c32d0] Final                
};

/// Class /Game/Effects/Sequence/Lobby/SQ_Lobby_CamIntro.SequenceDirector_C
...
public:
	...
	/// Functions
	// Function /Game/Effects/Sequence/Lobby/SQ_Lobby_CamIntro.SequenceDirector_C.SequenceEvent__ENTRYPOINTSequenceDirector
	// void SequenceEvent__ENTRYPOINTSequenceDirector();                                                                     // [0x61c32d0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Sequence/Lobby/SQ_Lobby_CamIntro.SequenceDirector_C.MatineeEvent
	// void MatineeEvent();                                                                                                  // [0x61c32d0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Sequence/Lobby/SQ_Lobby_CamIntro.SequenceDirector_C.ExecuteUbergraph_SequenceDirector
	// void ExecuteUbergraph_SequenceDirector(int32_t EntryPoint);                                                           // [0x61c32d0] Final                
};
...
public:
	...
	// void FX_SpawnDissolveEmitter(bool HideWeapon, bool FPV, class USceneComponent* Mesh, class UObject* __WorldContext);  // [0x61c32d0] Static|Public|BlueprintCallable|BlueprintEvent 
};
