...
public:
	...
	// void ReadyForActivation();                                                                                            // [0x84929d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask.GenericGameplayTaskDelegate__DelegateSignature
	// void GenericGameplayTaskDelegate__DelegateSignature();                                                                // [0x61c32d0] MulticastDelegate|Public|Delegate 
	// Function /Script/GameplayTasks.GameplayTask.EndTask
	// void EndTask();                                                                                                       // [0x8492670] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UGameplayTask_ClaimResource* ClaimResources(TScriptInterface<Class> InTaskOwner, TArray<UClass*> ResourceClasses, char Priority, FName TaskInstanceName); // [0x84924a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask_ClaimResource.ClaimResource
	// class UGameplayTask_ClaimResource* ClaimResource(TScriptInterface<Class> InTaskOwner, class UClass* ResourceClass, char Priority, FName TaskInstanceName); // [0x8492330] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,847) /* FMulticastInlineDelegate */ __um(success);                                            // 0x0070   (0x0010)  
	SDK_UNDEFINED(16,848) /* FMulticastInlineDelegate */ __um(DidNotSpawn);                                        // 0x0080   (0x0010)  
	...
	// class UGameplayTask_SpawnActor* SpawnActor(TScriptInterface<Class> TaskOwner, FVector SpawnLocation, FRotator SpawnRotation, class UClass* Class, bool bSpawnOnlyOnAuthority); // [0x84929f0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask_SpawnActor.FinishSpawningActor
	// void FinishSpawningActor(class UObject* WorldContextObject, class AActor* SpawnedActor);                              // [0x8492690] Native|Public|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask_SpawnActor.BeginSpawningActor
	// bool BeginSpawningActor(class UObject* WorldContextObject, class AActor*& SpawnedActor);                              // [0x8492250] Native|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,849) /* FMulticastInlineDelegate */ __um(OnFinished);                                         // 0x0070   (0x0010)  
	SDK_UNDEFINED(16,850) /* FMulticastInlineDelegate */ __um(OnTimeExpired);                                      // 0x0080   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,851) /* FMulticastInlineDelegate */ __um(OnFinish);                                           // 0x0070   (0x0010)  
	unsigned char                                      UnknownData00_6[0x8];                                       // 0x0080   (0x0008)  MISSED


	/// Functions
	// Function /Script/GameplayTasks.GameplayTask_WaitDelay.TaskWaitDelay
	// class UGameplayTask_WaitDelay* TaskWaitDelay(TScriptInterface<Class> TaskOwner, float Time, char Priority);           // [0x8492bc0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask_WaitDelay.TaskDelayDelegate__DelegateSignature
	// void TaskDelayDelegate__DelegateSignature();                                                                          // [0x61c32d0] MulticastDelegate|Public|Delegate 
};
...
public:
	...
	SDK_UNDEFINED(16,852) /* FMulticastInlineDelegate */ __um(OnClaimedResourcesChange);                           // 0x0118   (0x0010)  


	/// Functions
	// Function /Script/GameplayTasks.GameplayTasksComponent.OnRep_SimulatedTasks
	// void OnRep_SimulatedTasks();                                                                                          // [0x84929b0] Final|Native|Public  
	// Function /Script/GameplayTasks.GameplayTasksComponent.K2_RunGameplayTask
	// EGameplayTaskRunResult K2_RunGameplayTask(TScriptInterface<Class> TaskOwner, class UGameplayTask* Task, char Priority, TArray<UClass*> AdditionalRequiredResources, TArray<UClass*> AdditionalClaimedResources); // [0x8492760] Final|Native|Static|Public|BlueprintCallable 
};
